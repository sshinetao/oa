...
public partial class SalaryManage_PayPrint : System.Web.UI.Page
{
    private SalaryManage_PayForm MyPayForm;
    protected void Page_Load(object sender, EventArgs e)
    {//将查询结果输出到Excel文件中
        MyPayForm = (SalaryManage_PayForm)Context.Handler;
