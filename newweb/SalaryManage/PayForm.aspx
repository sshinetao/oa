<%--文件名:PayForm.aspx--%>
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PayForm.aspx.cs" Inherits="SalaryManage_PayForm" Title="当前位置：工资管理->月度工资发放" %>
        ...
        <tr>
            <td align="left" style="font-size: 0.8em; width: 2232px; font-family: 宋体; height: 16px;
                ...
                发放部门:<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1"
                    ...
                    Text="查询" Width="80px" /><asp:Button ID="Button2" runat="server" OnClick="Button2_Click"
                        Text="打印" Width="80px" /></td>
        </tr>
        <tr>
