...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ComputeForm.aspx.cs" Inherits="SalaryManage_ComputeForm" Title="当前位置：工资管理->月度工资核算"  %>
    ...
    <table style="width: 556px; height: 161px">
        <tr>
            <td align="left" style="font-size: 0.8em; width: 2232px; font-family: 宋体; height: 16px;
                ...
                &nbsp;<asp:Label ID="Label1" runat="server" Width="1px"></asp:Label>部门:<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1"
                ...
                <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="发工资" Width="80px" /></td>
        </tr>
        <tr>
