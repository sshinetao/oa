<%--文件名:QueryDepartmentPrint.aspx--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryDepartmentPrint.aspx.cs" Inherits="QueryManage_QueryDepartmentPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>打印部门员工人事档案</title>
</head>
<body>
                ...
                <table style="width: 570px; height: 58px">
                    <tr>
                        <td align="center" style="font-weight: bold; font-size: 2.4em; width: 104px; font-family: 宋体">
                            <asp:Label ID="Label1" runat="server" Font-Names="宋体" Font-Size="Large" Text="Label"></asp:Label></td>
                    </tr>
                    <tr>
