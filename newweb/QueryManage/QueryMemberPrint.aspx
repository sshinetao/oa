<%--文件名:QueryMemberPrint.aspx--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryMemberPrint.aspx.cs" Inherits="QueryManage_QueryMemberPrint" %>
        ...
        <table style="font-size: 10pt; width: 581px; height: 90px">
            <tr>
                <td align="center" colspan="2">
                    <asp:Label ID="Label1" runat="server" Font-Names="宋体" Font-Size="X-Large" Text="Label" Font-Bold="True"></asp:Label></td>
            </tr>
            <tr>
                <td colspan="2" style="height: 33px">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label3" runat="server" Text="员工编号："></asp:Label></td>
            </tr>
            <tr>
                <td colspan="2" style="height: 44px">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br /><asp:Image ID="Image3" runat="server" Height="1px" ImageUrl="~/Images/MyThinLine.JPG"
                        Width="575px" /><br />
                    &nbsp;
                    ...
                    <asp:Image ID="Image8" runat="server" Height="1px" ImageUrl="~/Images/MyThinLine.JPG"
                        Width="575px" /><br />
                    &nbsp;
                    <asp:Label ID="Label30" runat="server" Text="补充说明："></asp:Label><asp:Image ID="Image9" runat="server" Height="1px" ImageUrl="~/Images/MyThinLine.JPG"
                        Width="575px" /><br />
                    员工家庭成员：<br />
                    <asp:GridView ID="GridView1" runat="server" Width="572px">
                    </asp:GridView>
                    员工工作简历：<br />
                    <asp:GridView ID="GridView2" runat="server" Width="572px">
                    </asp:GridView>
                    员工培训记录：<br />
                    <asp:GridView ID="GridView3" runat="server" Width="572px">
                    </asp:GridView>
                    员工奖惩记录：<br />
                    <asp:GridView ID="GridView4" runat="server" Width="572px">
                    </asp:GridView>
                    员工工作业绩：<br />
                    <asp:GridView ID="GridView5" runat="server" Width="572px">
                    </asp:GridView>
                    <asp:Image ID="Image10" runat="server" ImageUrl="~/Images/MyBoldLine.JPG" /><br />
                    <asp:Label ID="Label31" runat="server" Text="操作人员:"></asp:Label></td>
            </tr>
            <tr>
