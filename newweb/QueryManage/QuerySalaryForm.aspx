<%--文件名:QuerySalaryForm.aspx--%>
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QuerySalaryForm.aspx.cs" Inherits="QueryManage_QuerySalaryForm" Title="当前位置：查询管理->查询工资信息" %>
    ...
    <table style="width: 556px; height: 161px">
        <tr>
            <td align="center" style="font-size: 0.8em; width: 2232px; font-family: 宋体; height: 16px;
                ...
                </asp:DropDownList>&nbsp;<asp:Button ID="Button1" runat="server" Text="查询" Width="90px" />
                ...
                <asp:Button ID="Button6" runat="server" Text="打印住房基金入账单" Width="141px" OnClick="Button6_Click" /></td>
        </tr>
        <tr>
