...
public partial class QueryManage_QueryCheckPrint : System.Web.UI.Page
{
    private QueryManage_QueryCheckForm MyCheckForm;
    protected void Page_Load(object sender, EventArgs e)
    {//将查询结果输出到Excel文件中
        MyCheckForm = (QueryManage_QueryCheckForm)Context.Handler;
