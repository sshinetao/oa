...
public partial class QueryManage_QuerySalaryPrint : System.Web.UI.Page
{
    private QueryManage_QuerySalaryForm MySalaryForm;
    protected void Page_Load(object sender, EventArgs e)
    {//将查询结果输出到Excel文件中
        MySalaryForm = (QueryManage_QuerySalaryForm)Context.Handler;
        string MySQL = MySalaryForm.MyPrintSQL;
        this.Label1.Text = MySalaryForm.MyPrintTitle;
        this.Label2.Text = MySalaryForm.MyPrintDate;
