<%--文件名:QueryCheckForm.aspx--%>
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QueryCheckForm.aspx.cs" Inherits="QueryManage_QueryCheckForm" Title="当前位置：查询管理->查询考勤信息" %>
