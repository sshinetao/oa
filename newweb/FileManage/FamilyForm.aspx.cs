...
public partial class FileManage_FamilyForm : System.Web.UI.Page
{
    ...
    {//在控件中显示选择的记录
        ...
        this.DropDownList3.Text = this.GridView1.SelectedRow.Cells[6].Text.ToString();
