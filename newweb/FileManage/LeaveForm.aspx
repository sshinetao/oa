<%--文件名:LeaveForm.aspx--%>
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LeaveForm.aspx.cs" Inherits="FileManage_LeaveForm" Title="当前位置：人事管理->员工离职管理" %>
    ...
    <table style="width: 556px; height: 161px">
        ...
        <tr>
            <td align="left" style="font-size: 0.8em; width: 2232px; font-family: 宋体; height: 27px;
                ...
                离职日期:<asp:TextBox ID="TextBox3" runat="server" Width="88px">2000-4-12</asp:TextBox><br />
                &nbsp;离职原因:<asp:TextBox ID="TextBox4" runat="server" Width="473px">自动离职</asp:TextBox>&nbsp;<br />
                &nbsp;批准人:<asp:TextBox ID="TextBox5" runat="server" Width="44px">王廷明</asp:TextBox>
                补充说明:<asp:TextBox ID="TextBox6" runat="server" Width="370px">暂无</asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 2232px; height: 100px; background-color: gainsboro">
                <asp:Panel ID="Panel1" runat="server" Height="220px" ScrollBars="Auto" Width="553px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:MyPersonnelDBConnectionString %>"
                        DeleteCommand="DELETE FROM [离职管理] WHERE [自编号] = @自编号" InsertCommand="INSERT INTO [离职管理] ([员工编号], [员工姓名], [离职日期], [离职原因], [批准人], [补充说明]) VALUES (@员工编号, @员工姓名, @离职日期, @离职原因, @批准人, @补充说明)"
                        SelectCommand="SELECT * FROM [离职管理] WHERE ([员工姓名] LIKE '%' + @员工姓名 + '%')" UpdateCommand="UPDATE [离职管理] SET  [离职日期] = @离职日期, [离职原因] = @离职原因, [批准人] = @批准人, [补充说明] = @补充说明 WHERE [自编号] = @自编号">
                        <DeleteParameters>
                            <asp:Parameter Name="自编号" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>                     
                            <asp:ControlParameter ControlID="TextBox3" Name="离职日期" PropertyName="Text" Type="DateTime" />
                            <asp:ControlParameter ControlID="TextBox4" Name="离职原因" PropertyName="Text" Type="String" />
                            <asp:ControlParameter ControlID="TextBox5" Name="批准人" PropertyName="Text" Type="String" />
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="离职日期" HeaderText="离职日期" SortExpression="离职日期" />
                            <asp:BoundField DataField="离职原因" HeaderText="离职原因" SortExpression="离职原因" />
                            <asp:BoundField DataField="批准人" HeaderText="批准人" SortExpression="批准人" />
