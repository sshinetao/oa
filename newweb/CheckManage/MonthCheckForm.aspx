                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="自编号"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="C7" SortExpression="C7">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList10" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C7" DataValueField="C7" SelectedValue='<%# Bind("C7") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C8" SortExpression="C8">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList11" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C8" DataValueField="C8" SelectedValue='<%# Bind("C8") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C9" SortExpression="C9">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList12" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C9" DataValueField="C9" SelectedValue='<%# Bind("C9") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C10" SortExpression="C10">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList13" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C10" DataValueField="C10" SelectedValue='<%# Bind("C10") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C11" SortExpression="C11">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList14" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C11" DataValueField="C11" SelectedValue='<%# Bind("C11") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C12" SortExpression="C12">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList15" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C12" DataValueField="C12" SelectedValue='<%# Bind("C12") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C13" SortExpression="C13">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList16" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C13" DataValueField="C13" SelectedValue='<%# Bind("C13") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C14" SortExpression="C14">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList17" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C14" DataValueField="C14" SelectedValue='<%# Bind("C14") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C15" SortExpression="C15">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList18" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C15" DataValueField="C15" SelectedValue='<%# Bind("C15") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C16" SortExpression="C16">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList19" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C16" DataValueField="C16" SelectedValue='<%# Bind("C16") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C17" SortExpression="C17">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList20" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C17" DataValueField="C17" SelectedValue='<%# Bind("C17") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C18" SortExpression="C18">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList21" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C18" DataValueField="C18" SelectedValue='<%# Bind("C18") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C19" SortExpression="C19">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList22" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C19" DataValueField="C19" SelectedValue='<%# Bind("C19") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C20" SortExpression="C20">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList23" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C20" DataValueField="C20" SelectedValue='<%# Bind("C20") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C21" SortExpression="C21">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList24" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C21" DataValueField="C21" SelectedValue='<%# Bind("C21") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C22" SortExpression="C22">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList25" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C22" DataValueField="C22" SelectedValue='<%# Bind("C22") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C23" SortExpression="C23">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList26" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C23" DataValueField="C23" SelectedValue='<%# Bind("C23") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C24" SortExpression="C24">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList27" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C24" DataValueField="C24" SelectedValue='<%# Bind("C24") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C25" SortExpression="C25">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList28" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C25" DataValueField="C25" SelectedValue='<%# Bind("C25") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C26" SortExpression="C26">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList29" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C26" DataValueField="C26" SelectedValue='<%# Bind("C26") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C27" SortExpression="C27">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList30" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C27" DataValueField="C27" SelectedValue='<%# Bind("C27") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C28" SortExpression="C28">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList31" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C28" DataValueField="C28" SelectedValue='<%# Bind("C28") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C29" SortExpression="C29">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList32" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C29" DataValueField="C29" SelectedValue='<%# Bind("C29") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C30" SortExpression="C30">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList33" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C30" DataValueField="C30" SelectedValue='<%# Bind("C30") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
                            ...
                            <asp:TemplateField HeaderText="C31" SortExpression="C31">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList34" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource2"
                                        DataTextField="C31" DataValueField="C31" SelectedValue='<%# Bind("C31") %>'>
                                        <asp:ListItem Selected="True">/</asp:ListItem>                             
                                        <asp:ListItem>&gt;</asp:ListItem>
                                        <asp:ListItem>&lt;</asp:ListItem>
                                        <asp:ListItem>√</asp:ListItem>
