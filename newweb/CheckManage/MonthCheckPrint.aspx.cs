...
public partial class CheckManage_MonthCheckPrint : System.Web.UI.Page
{
   // private CheckManage_MonthCheckForm MyMonthCheckForm;
    protected void Page_Load(object sender, EventArgs e)
    {//将查询结果输出到Excel文件中
       // MyMonthCheckForm = (CheckManage_MonthCheckForm)Context.Handler;
        string MySQL = "";// MyMonthCheckForm.MyPrintSQL;
        this.Label1.Text = "";// MyMonthCheckForm.MyPrintTitle;
        this.Label2.Text = "";// MyMonthCheckForm.MyPrintDate + "  (考勤符号说明：出勤/，迟到>，早退< ，产假√， 事假#， 病假+， 婚假△， 旷工×)";
