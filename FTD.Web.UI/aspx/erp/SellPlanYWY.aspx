<%@ Page language="c#" Codebehind="SellPlanYWY.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellPlanYWY" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						<TD style="WIDTH: 101px"><FONT face="宋体">业务员关键字：</FONT></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="SellsName" SortExpression="SellsName" HeaderText="业务员">
												...
												<asp:BoundColumn DataField="Starttime" HeaderText="开始时间" DataFormatString="{0:yyyy-M-dd}"></asp:BoundColumn>
												<asp:BoundColumn DataField="Endtime" HeaderText="结束时间" DataFormatString="{0:yyyy-M-dd}"></asp:BoundColumn>
