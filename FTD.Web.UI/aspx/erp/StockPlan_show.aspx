<%@ Page language="c#" Codebehind="StockPlan_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockPlan_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="StockPlan.aspx">生产计划</A>&nbsp;&gt;&gt; 
									查看生产计划</td>
							</tr>
						</table>
					</td>
										...
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="tilte" runat="server" Width="100%" ></asp:textbox></td>
													<td align="right"><FONT face="宋体">指定人：</FONT></td>
												...
												<td width="100%" colSpan="4">
													<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" BorderWidth="1px"
															...
															<Columns>
																...
																<asp:BoundColumn DataField="CompanyAdd" SortExpression="CompanyName" HeaderText="供应商名称">
																	<HeaderStyle Wrap="False"></HeaderStyle>
																	<ItemStyle Wrap="False"></ItemStyle>
																</asp:BoundColumn>
															</Columns>
