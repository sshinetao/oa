...
{
	/// <summary>
	/// StockOut_gz_rz 的摘要说明。
	/// </summary>
	public class StockOut_gz_rz : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from StockOutlog_lc  where KeyField='"+Request.QueryString["number"]+"' order by id desc";
		...
		{
			Response.Redirect("StockOut_gz.aspx?id="+Request.QueryString["id"].ToString()+"");
		}
