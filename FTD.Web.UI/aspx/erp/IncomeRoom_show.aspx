...
<%@ Page language="c#" Codebehind="IncomeRoom_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.IncomeRoom_show" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="title" runat="server" Width="90%" ></asp:textbox></td>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="Storeroom" runat="server" Width="90%" ></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%" style="HEIGHT: 33px"><FONT face="宋体">入库来源：</FONT></td>
												<td width="35%" style="HEIGHT: 33px">
													<asp:textbox id="InSource" runat="server" Width="90%" ></asp:textbox></td>
												<td align="right" style="HEIGHT: 33px"><FONT face="宋体">状态：</FONT></td>
												<td style="HEIGHT: 33px"><asp:textbox id="State" runat="server" Width="90%" ></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%" style="HEIGHT: 33px"><FONT face="宋体">选择审批流程：</FONT></td>
												<td width="35%" style="HEIGHT: 33px">
                                                        <asp:textbox id="StreamName" runat="server" Width="90%" ></asp:textbox>
												</td>
                                                <td align="right" width="15%"><FONT face="宋体">入库类型：</FONT></td>
												<td  width="35%">
                                                    <asp:textbox ID="Rukuleixing" runat="server" Width="90%" ></asp:textbox>
												</td>
												
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right"><FONT face="宋体">摘要：</FONT></td>
												<td colSpan="3"><asp:textbox id="Remark" runat="server" Width="90%" TextMode="MultiLine" Height="52px" ></asp:textbox><A href="javascript:void(0)"></A></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
