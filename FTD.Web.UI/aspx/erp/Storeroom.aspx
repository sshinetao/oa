<%@ Page language="c#" Codebehind="Storeroom.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Storeroom" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Principal" SortExpression="Principal" HeaderText="负责人"></asp:BoundColumn>
											<asp:BoundColumn DataField="Users" SortExpression="Users" HeaderText="用途"></asp:BoundColumn>
										</Columns>
