<%@ Page language="c#" Codebehind="BB_StockOutMoney_BT_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_StockOutMoney_BT_show" %>
						...
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td width="97%"><FONT color="#ffffff"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt; 
										应付款报表 &gt;&gt; <A class="line_b" href="BB_StockOutMoney_BT.aspx">按采购订单显示</A>&nbsp; &gt;&gt; 查看订单</FONT></td>
							</tr>
						</table>
					</td>
