...
namespace qpsmartweb_jxc
{
	...
	/// SellQuote 的摘要说明。
	/// </summary>
	public class SellQuote : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from SellQuote where  title like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'  and Username='"+this.Session["username"]+"'  order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from SellQuote  where Username='"+this.Session["username"]+"' order  by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("SellQuote.aspx?str="+tilte.Text+"");
		}
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string SQL_Del = "Delete from SellQuote where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void Imagebutton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellQuote_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton9_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellQuote_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		{
			Response.Redirect("SellQuote_add.aspx");
		}
		...
		private void Imagebutton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellQuote   set Type='执行完毕' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					
					List.ExeSql(SQL_Del);


					string Sql_update ="Update SellQuoteMx Set Type='执行完毕' where Keyfile='"+Datagrid2.SelectedItem.Cells[8].Text.ToString()+"'";
					List.ExeSql(Sql_update);//明细

					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[执行完毕]');window.location.href='SellQuote.aspx'</script>");
				}
		...
		private void Imagebutton7_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellQuote   set Type='强制停止' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					
					List.ExeSql(SQL_Del);


					string Sql_update ="Update SellQuoteMx Set Type='强制停止' where Keyfile='"+Datagrid2.SelectedItem.Cells[8].Text.ToString()+"'";
					List.ExeSql(Sql_update);//明细



					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[强制停止]');window.location.href='SellQuote.aspx'</script>");
				}
		...
		private void Imagebutton8_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellQuote   set Type='作废' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					
					List.ExeSql(SQL_Del);//计划



					string Sql_update ="Update SellQuoteMx Set Type='作废' where Keyfile='"+Datagrid2.SelectedItem.Cells[8].Text.ToString()+"'";
					List.ExeSql(Sql_update);//明细

					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[作废]');window.location.href='SellQuote.aspx'</script>");
				}
