...
namespace qpsmartweb_jxc
{
	...
	/// GoodsData_spk 的摘要说明。
	/// </summary>
	public class GoodsData_spk : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from GoodsData where State='启用' and GoodsName like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'   order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from GoodsData where State='启用'  order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		...
		{
		Response.Redirect("GoodsData_spk.aspx?str="+GoodsName.Text+"");
		}
