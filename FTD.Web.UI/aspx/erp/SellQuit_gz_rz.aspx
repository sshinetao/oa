<%@ Page language="c#" Codebehind="SellQuit_gz_rz.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellQuit_gz_rz" %>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%"><FONT color="#ffffff"><a href="main_1.aspx" class="line_b">工作台</a>&nbsp;&gt;&gt;
										<a href="SellQuit.aspx" class="line_b">销售退货</a>&nbsp;&gt;&gt; 操作日志</FONT></td>
							</tr>
						</table>
					</td>
