<%@ Page language="c#" Codebehind="Cgfk_WorkStreamName_add_add.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Cgfk_WorkStreamName_add_add" %>
...
<HTML>
	<HEAD>
		...
		window.onerror = killErrors;	
            ...
            {  
				 var num=Math.random();
				 wName=window.showModalDialog("open_Cgfk_WorkStreamJd.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");               
			...
			<table height="450" cellSpacing="0" cellPadding="0" width="100%" border="0" id="Table3">
				<tr>
					...
					<td vAlign="top" width="95%">
								...
								<td vAlign="top" bgColor="#f3f8fe">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0" id="Table6">
										...
										<tr bgColor="#f3f8fe">
											...
											<td>
												<asp:textbox id="realname" runat="server" Width="90%" ></asp:textbox><A href="JavaScript:void(0)"><IMG onclick="usOpen()" alt="" src="image/FDJ.gif" border="0"></A></td>
										</tr>
									</table>
						...
						<asp:TextBox id="Name_type" runat="server"  Visible="False"></asp:TextBox>
						<asp:TextBox id="KeyFile" runat="server"  Visible="False"></asp:TextBox>
					</td>
					<td width="15">&nbsp;</td>
				</tr>
			</table>
