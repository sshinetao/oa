<%@ Page language="c#" Codebehind="StockPlan_add_add.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockPlan_add_add" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;新增采购计划明细
								</td>
							</tr>
						</table>
					</td>
									...
									<table id="Table6" cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="GoodsNumber" runat="server" Width="90%" ></asp:textbox>
                                                    <A href="javascript:void(0)"><IMG onclick="cpOpen();" alt="" src="image/FDJ.gif" border="0"></A></td>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox onkeypress="var k=event.keyCode; return (k>=48&amp;&amp;k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData('text'))"
														id="SingleMoney" ondragenter="return false" style="IME-MODE: disabled" runat="server" Width="90%" onmouseout="selstr()">0</asp:textbox><A href="javascript:void(0)"><IMG onclick="cgjOpen();" alt="" src="image/FDJ.gif" border="0"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">采购总金额：</FONT></td>
												<td width="35%"><asp:textbox onkeypress="var k=event.keyCode; return (k>=48&amp;&amp;k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData('text'))"
														id="Allmoney" ondragenter="return false" style="IME-MODE: disabled" runat="server" Width="100%" onclick="selstr(this,this);return false">0</asp:textbox></td>
												<td align="right" width="15%"><FONT face="宋体">订购方式：</FONT></td>
												<td width="35%">
													<asp:DropDownList id="Stocktype" runat="server" Width="100%">
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="StockPeoName" runat="server" Width="90%" ></asp:textbox>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="JyOrderTime" runat="server" Width="85%"  DataType="DateTime"></asp:textbox>
													<script>SetNeed('JyOrderTime')</script>
													</FONT><A href="javascript:void(0)"><IMG id="JyOrderTime_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
															src="image/FDJ.gif" border="0"></A></td>
												<td align="right" width="15%"><FONT face="宋体">到货建议日期：</FONT></td>
												<td width="35%">
													<asp:textbox id="JyToTime" runat="server" Width="85%"  DataType="DateTime"></asp:textbox>
													<script>SetNeed('JyToTime')</script>
													</FONT><A href="javascript:void(0)"><IMG id="JyToTime_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
															src="image/FDJ.gif" border="0"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">提醒日期：</FONT></td>
												<td width="35%"><asp:textbox id="TxTime" runat="server" Width="85%" ></asp:textbox>
													<script>SetNeed('TxTime')</script>
													</FONT><A href="javascript:void(0)"><IMG id="TxTime_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
															src="image/FDJ.gif" border="0"></A></td>
							...
							<TR>
								<td background="i_blue/third_head_bg1.jpg">
									<table id="Table8" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td width="39%">&nbsp;</td>
											<td width="9%"><asp:imagebutton id="ImageButton1" runat="server" ImageUrl="i_blue/ok.jpg" onmouseover="selstr()" OnClick="ImageButton1_Click1"></asp:imagebutton></td>
...
document.getElementById("SingleMoney").value=arr[4]; 
...
document.getElementById("StockPeoNum").value=arr[2]; 
        ...
        function  cgjOpen()  
            {  
            var num=Math.random();
                wName_4=window.showModalDialog("open_GoodsOpenMoney.aspx?tmp="+num+" ","window","dialogWidth:700px;DialogHeight=500px;status:no;scroll=yes;help:no");                
...
document.getElementById("CountUnit").value=arr[2]; 
document.getElementById("Model").value=arr[3]; 
document.getElementById("CompanyName").value=arr[4]; 
document.getElementById("CompanyNumber").value=arr[5]; 
document.getElementById("SingleMoney").value=arr[6]; 
