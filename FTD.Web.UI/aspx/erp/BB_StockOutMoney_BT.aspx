<%@ Page language="c#" Codebehind="BB_StockOutMoney_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_StockOutMoney_BT" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						...
						<TD style="WIDTH: 52px"><FONT face="宋体">采购员：</FONT></TD>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="YfMoney" SortExpression="YfMoney" HeaderText="已付金额">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn HeaderText="剩余金额">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
									...
									<FONT face="宋体" color="#ff0000"><STRONG>金额总计：<%=allmoney%>
											元&nbsp;&nbsp;&nbsp;已付金额：<%=yfmoney%>&nbsp;&nbsp;&nbsp;剩余金额：<%=symoney%></STRONG></FONT>
