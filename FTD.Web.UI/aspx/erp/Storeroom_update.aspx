<%@ Page language="c#" Codebehind="Storeroom_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Storeroom_update" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="Principal" runat="server" Width="90%"></asp:textbox><A href="JavaScript:void(0)"><IMG onclick="usOpen()" alt="" src="image/FDJ.gif" border="0"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
