<%@ Page language="c#" Codebehind="StockPlan_BB_BT_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockPlan_BB_BT_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="StockPlan_BB_BT.aspx">采购计划报表</A>&nbsp;&gt;&gt; 
									查看采购计划</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td align="right" width="15%"><FONT face="宋体"><FONT face="宋体">是否共享：</FONT></FONT></td>
												<td width="35%">
													<asp:DropDownList id="Ifopen" runat="server" Width="100%" Enabled="False">
														<asp:ListItem Value="否">否</asp:ListItem>
														<asp:ListItem Value="是">是</asp:ListItem>
													</asp:DropDownList></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">计划开始时间：</FONT></td>
												<td width="35%"><asp:textbox id="StartTime" runat="server" Width="100%"  DataType="DateTime"></asp:textbox>
													<script>SetNeed('StartTime')</script>
													</FONT><A href="javascript:void(0)"></A></td>
												<td align="right" width="15%"><FONT face="宋体">计划结束时间：</FONT></td>
												<td width="35%"><asp:textbox id="EndTime" runat="server" Width="100%"  DataType="DateTime"></asp:textbox>
