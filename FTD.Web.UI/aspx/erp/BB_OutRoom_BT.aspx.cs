...
namespace qpsmartweb_jxc
{
	...
	/// BB_OutRoom_BT 的摘要说明。
	/// </summary>
	public class BB_OutRoom_BT : System.Web.UI.Page
	{
		...
		public string CreateMidSql()
		{
			...
			if (this.OutUse.Text.Trim() != "")
			{
				MidSql=MidSql+" and OutUse = '"+this.OutUse.Text.Trim()+"'";
			}
	


			if (this.ThPeople.Text.Trim() != "")
			{
				MidSql=MidSql+" and ThPeople like '%"+this.ThPeople.Text.Trim()+"%'";
			}



			if (this.ThTime.Text.Trim() != "" )
			{
				MidSql=MidSql+" and convert(char(10),cast(ThTime as datetime),120)=convert(char(10),cast('"+this.ThTime.Text+"' as datetime),120) ";
			}	
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from OutRoom where 1=1 "+Server.UrlDecode(Request.QueryString["str"])+" ";
			...
			else
			{
				...
				string SQL_GetList_xs    =  "select * from OutRoom order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();	
		...
		{
			Response.Redirect("BB_OutRoom_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_OutRoom_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
