<%@ Page language="c#" Codebehind="InSource.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.InSource" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="IfSystem" SortExpression="IfSystem" HeaderText="是否为系统库"></asp:BoundColumn>
										</Columns>
