...
<%@ Page language="c#" Codebehind="SellOrder_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOrder_update" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
                                            ...
                                            <tr bgColor="#f3f8fe">
												...
												<td>
                                                    <asp:textbox id="Seller" Width="90%" runat="server"></asp:textbox>
