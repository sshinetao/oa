...
<%@ Page language="c#" Codebehind="StockOut.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOut" %>
						...
						<TD style="WIDTH: 85px"><FONT face="宋体">标题关键字：</FONT></TD>
                         <td style="WIDTH: 143px">
                            <asp:DropDownList runat="server" ID="selectList">
                                ...
                                <asp:ListItem Value="ShTime">退料日期</asp:ListItem>
                                ...
                                <asp:ListItem Value="Traffic">运输单位</asp:ListItem>
                                <asp:ListItem Value="Balance">结算方式</asp:ListItem>
                            </asp:DropDownList></td>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="ShTime" SortExpression="ShTime" HeaderText="退料日期" DataFormatString="{0:yyyy-M-dd}">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
