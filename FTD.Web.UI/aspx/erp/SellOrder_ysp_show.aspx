...
<%@ Page language="c#" Codebehind="SellOrder_ysp_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOrder_ysp_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="SellOrder_ysp.aspx">我审批的订单</A>&nbsp;&gt;&gt; 
									查看我审批的订单</td>
							</tr>
						</table>
					</td>
