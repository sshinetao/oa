...
{
	/// <summary>
	/// StockOrder_gz_rz 的摘要说明。
	/// </summary>
	public class StockOrder_gz_rz : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from StockOrderlog_lc  where KeyField='"+Request.QueryString["number"]+"' order by id desc";
		...
		{
			Response.Redirect("StockOrder_gz.aspx?id="+Request.QueryString["id"].ToString()+"");
		}
