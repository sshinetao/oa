<%@ Page language="c#" Codebehind="Systemnbdxx_2.aspx.cs" AutoEventWireup="false" Inherits="bjoa.Systemnbdxx_2" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="acceptrealname" HeaderText="接受人"></asp:BoundColumn>
