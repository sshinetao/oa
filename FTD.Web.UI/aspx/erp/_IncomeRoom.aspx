...
<%@ Page language="c#" Codebehind="_IncomeRoom.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.IncomeRoom" %>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="StockPeoName" SortExpression="StockPeoName" HeaderText="收料人姓名">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
