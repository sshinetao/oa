<%@ Page language="c#" Codebehind="StockOutMoney_ysp_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOutMoney_ysp_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="StockOutMoney_ysp.aspx">我审批的采购付款</A>&nbsp;&gt;&gt; 
									查看采购付款</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td><asp:textbox id="StreamName" runat="server" Width="100%" ></asp:textbox>
												</td>
												<td align="right"><FONT face="宋体">录入人：</FONT></td>
												<td><asp:textbox id="realname" runat="server" Width="100%" ></asp:textbox>
												</td>
											</tr>
										</TBODY>
									</table>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td align="right"><FONT face="宋体">录入人：</FONT></td>
												<td>
													<asp:textbox id="ddrealname" runat="server"  Width="100%"></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right"><FONT face="宋体">选择审批流程：</FONT></td>
