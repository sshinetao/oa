...
<%@ Page language="c#" Codebehind="SellInMoney_ysp_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellInMoney_ysp_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="SellInMoney_ysp.aspx">我审批的销售收款</A>&nbsp;&gt;&gt; 
									查看我审批的销售收款</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td><asp:textbox id="IncomeSet" runat="server" Width="100%" ></asp:textbox><A href="javascript:void(0)"></A></td>
											...
											<tr bgColor="#f3f8fe">
												...
												<td>
													<asp:textbox id="JbName" runat="server" Width="100%" ></asp:textbox><A href="javascript:void(0)"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
											...
											<tr bgColor="#f3f8fe">
												...
												<td align="right">我的操作：</td>
												<td><asp:textbox id="SpCz" runat="server" Width="100%" ></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right"><FONT face="宋体">审批备注：</FONT></td>
												<td colSpan="3"><asp:textbox id="Sreakmart" runat="server" Width="100%" TextMode="MultiLine" Height="52px" ></asp:textbox><A href="javascript:void(0)"></A></FONT></td>
											</tr>
										</TBODY>
									</table>
									<hr>
