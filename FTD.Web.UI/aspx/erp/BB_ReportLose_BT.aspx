<%@ Page language="c#" Codebehind="BB_ReportLose_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_ReportLose_BT" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						<TD style="WIDTH: 52px"><FONT face="宋体">报损人：</FONT></TD>
						<TD style="WIDTH: 106px"><asp:textbox id="StockPeoName" runat="server" Width="88px"></asp:textbox></TD>
						<TD style="WIDTH: 61px"><FONT face="宋体">报损日期：</FONT></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" BorderWidth="1px"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="BsTimes" SortExpression="BsTimes" HeaderText="报损日期" DataFormatString="{0:yyyy-M-dd}">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="StockPeoName" SortExpression="StockPeoName" HeaderText="报损人">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
