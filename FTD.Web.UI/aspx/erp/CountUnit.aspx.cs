...
namespace qpsmartweb_jxc
{
	...
	/// CountUnit 的摘要说明。
	/// </summary>
	public class CountUnit : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("CountUnit_add.aspx");
		}
		...
		private void ImageButton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('删除[计量单位]','计量单位','"+this.Session["UserName"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
				List.ExeSql(sql_insert_xtrz);


				string SQL_Del = "Delete from CountUnit where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					
				List.ExeSql(SQL_Del);

				Response.Redirect("CountUnit.aspx");
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("CountUnit_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
