<%@ Page language="c#" Codebehind="BB_ReportSpill_HW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_ReportSpill_HW" %>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="Storeroom" SortExpression="Storeroom" HeaderText="对应仓库">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
											</Columns>
