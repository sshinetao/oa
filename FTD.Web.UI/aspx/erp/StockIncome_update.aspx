<%@ Page language="c#" Codebehind="StockIncome_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockIncome_update" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="StockIncome.aspx">采购入库</A>&nbsp;&gt;&gt; 
									修改采购入库</td>
							</tr>
						</table>
					</td>
...
document.getElementById("StockPeoNum").value=arr[2]; 
        ...
        function  splc()  
            {  
            var num=Math.random();
                wName_5=window.showModalDialog("open_Cgrk_stream.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");                
