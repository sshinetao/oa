...
<%@ Page language="c#" Codebehind="OutRoom_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OutRoom_sp" %>
                        ...
                        <td style="WIDTH: 143px">
                            <asp:DropDownList runat="server" ID="selectList">
                                ...
                                <asp:ListItem Value="Storeroom">出货仓</asp:ListItem>
                                 <asp:ListItem Value="StockPeoName">提货人</asp:ListItem>
                                <asp:ListItem Value="Tel">提货人电话</asp:ListItem>
                                <asp:ListItem Value="ShTime">提货时间</asp:ListItem>
                                <asp:ListItem Value="OutUse">出库用途</asp:ListItem>
                                <asp:ListItem Value="Realname">录入人</asp:ListItem>
                            </asp:DropDownList></td>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="Tel" SortExpression="Tel" HeaderText="提货人电话"></asp:BoundColumn>
												<asp:BoundColumn DataField="ThTime" SortExpression="ThTime" HeaderText="提货时间" DataFormatString="{0:yyyy-M-dd}">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
