<%@ Page language="c#" Codebehind="BB_ReportSpill_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_ReportSpill_BT" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						...
						<TD style="WIDTH: 106px"><asp:textbox id="Storeroom" runat="server" Width="72px" ></asp:textbox><A href="javascript:void(0)"><IMG onclick="jhcOpen();" alt="" src="image/FDJ.gif" border="0"></A></TD>
						<TD style="WIDTH: 61px"><FONT face="宋体">开始时间：</FONT></TD>
						<TD style="WIDTH: 118px"><asp:TextBox id="Starttime" runat="server" Width="80px" ></asp:TextBox>
						...
						<TD style="WIDTH: 104px"><asp:TextBox id="Endtime" runat="server" Width="80px" ></asp:TextBox>
						...
						<TD style="WIDTH: 241px"></FONT></TD>
						<TD></TD>
					</TR>
					<TR>
						<TD style="WIDTH: 52px"><FONT face="宋体">报溢人：</FONT></TD>
						<TD style="WIDTH: 106px"><asp:textbox id="StockPeoName" runat="server" Width="88px"></asp:textbox></TD>
						<TD style="WIDTH: 61px"><FONT face="宋体">报溢日期：</FONT></TD>
						<TD style="WIDTH: 118px"><asp:TextBox id="BsTimes" runat="server" Width="80px" ></asp:TextBox>
						...
						<TD style="WIDTH: 104px">
							<asp:imagebutton id="Imagebutton3" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton>
						</TD>
						<TD style="WIDTH: 241px"></FONT></TD>
						<TD></TD>
					</TR>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" BorderWidth="1px"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="BsTimes" SortExpression="BsTimes" HeaderText="报溢日期" DataFormatString="{0:yyyy-M-dd}">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="StockPeoName" SortExpression="StockPeoName" HeaderText="报溢人">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
