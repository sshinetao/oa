<%@ Page language="c#" Codebehind="BB_YWY.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_YWY" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						<TD style="WIDTH: 66px"><FONT face="宋体">业务员：</FONT></TD>
						<TD style="WIDTH: 93px"><asp:TextBox id="StockPeoName" runat="server" Width="88px"></asp:TextBox></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn HeaderText="销售金额">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
											</Columns>
