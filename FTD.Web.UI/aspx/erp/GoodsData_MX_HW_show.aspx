<%@ Page language="c#" Codebehind="GoodsData_MX_HW_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsData_MX_HW_show" %>
						...
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td width="97%"><FONT color="#ffffff"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt; 
										库房明细 &gt;&gt; <A class="line_b" href="GoodsData_MX_HW.aspx">按货物显示</A>&nbsp;&gt;&gt; 
										查看明细</FONT></td>
							</tr>
						</table>
					</td>
