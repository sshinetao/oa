...
{
	/// <summary>
	/// Xsdd_WorkStreamName_add_pdzj 的摘要说明。
	/// </summary>
	public class Xsdd_WorkStreamName_add_pdzj : System.Web.UI.Page
	{
		...
		private void ImageButton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			string Sql_update ="Update Xsdd_WorkStreamName Set realname=realname+'|"+realname.Text+"',username=username+'|"+username.Text+"' where id='" + int.Parse(Request.QueryString["id"])+"'";
