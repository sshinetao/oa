<%@ Page language="c#" Codebehind="GoodsMove_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsMove_show" %>
		 ...
		 function del()
		  {
            ...
            var num=Math.random();
            var number=document.getElementById('number').value;
           window.showModalDialog("GoodsMove_add_add.aspx?tmp="+num+"&number="+number+" ","window","dialogWidth:700px;DialogHeight=400px;status:no;scroll=yes;help:no");                
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="GoodsMove.aspx">货物调拨</A>&nbsp;&gt;&gt; 
									查看货物调拨</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="Uses" runat="server" Width="100%" ></asp:textbox></td>
