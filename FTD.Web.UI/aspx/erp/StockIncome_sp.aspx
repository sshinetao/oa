...
<%@ Page language="c#" Codebehind="StockIncome_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockIncome_sp" %>
					...
					<TR>
                        ...
                        <td style="WIDTH: 143px">
                            <asp:DropDownList runat="server" ID="selectList">
                                ...
                                <asp:ListItem Value="StockPeoName">运输单位</asp:ListItem>
                                <asp:ListItem Value="AllMoney">结算方式</asp:ListItem>
                            </asp:DropDownList></td>
