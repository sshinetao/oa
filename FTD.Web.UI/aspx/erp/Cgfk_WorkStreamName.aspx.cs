...
{
	/// <summary>
	/// Cgfk_WorkStreamName 的摘要说明。
	/// </summary>
	public class Cgfk_WorkStreamName : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (Request.QueryString["Del"]!= null)
			{
				try 
				{
					string SQL_Del = "Delete from Cgfk_WorkStreamName where Id=" +Request.QueryString["Del"];
					List.ExeSql(SQL_Del);
			...
			string    SQL_Label2     =   "select  * from Cgfk_WorkStreamName where KeyFile='"+KeyFile.Text+"' order by id asc";
		...
		{
			this.Response.Write("<script language=javascript>alert('设置成功！');window.location.href='Cgfk_stream.aspx'</script>");
		}
	}
}
