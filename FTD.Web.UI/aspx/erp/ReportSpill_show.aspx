<%@ Page language="c#" Codebehind="ReportSpill_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.ReportSpill_show" %>
		 ...
		 function del()
		  {
           ...
           window.showModalDialog("ReportSpill_add_add.aspx?tmp="+num+"&number="+number+" ","window","dialogWidth:700px;DialogHeight=400px;status:no;scroll=yes;help:no");                
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="ReportSpill.aspx">报溢</A>&nbsp;&gt;&gt; 
									查看报溢</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td align="right" width="15%"><FONT face="宋体">报溢日期：</FONT></td>
												<td width="35%"><asp:textbox id="BsTimes" runat="server"  Width="100%"></asp:textbox>
													<script>SetNeed('BsTimes')</script>
													</FONT>
												</td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%">报溢人：</td>
												...
												<td width="100%" colSpan="4">
													<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" BorderWidth="1px"
															...
															<Columns>
																...
																<asp:BoundColumn DataField="StockPoint" SortExpression="StockPoint" HeaderText="报溢数量">
																	<HeaderStyle Wrap="False"></HeaderStyle>
																	<ItemStyle Wrap="False"></ItemStyle>
																</asp:BoundColumn>
															</Columns>
