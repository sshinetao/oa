<%@ Page language="c#" Codebehind="open_CountUnit.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_CountUnit" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%" class="headfont">计量单位检索</td>
							</tr>
						</table>
					</td>
											...
											<td width="100%"><FONT face="宋体">
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															...
															<asp:BoundColumn DataField="Name" HeaderText="计量单位"></asp:BoundColumn>
														</Columns>
