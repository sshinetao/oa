<%@ Page language="c#" Codebehind="open_GoodsData.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_GoodsData" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%" class="headfont">商品选择</td>
							</tr>
						</table>
					</td>
									...
									<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#d8e1e8">
										<tr bgcolor="#f3f8fe">
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="25%"><FONT face="宋体">商品关键字：</FONT></td>
														<td width="42%">
													...
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															<asp:TemplateColumn>
																...
																<ItemTemplate>
																	&nbsp;<INPUT type="radio"  name="Rad" id="Radio1"  CHECKED value='<%#DataBinder.Eval(Container.DataItem, "Number")%>|<%#DataBinder.Eval(Container.DataItem, "GoodsName")%>|<%#DataBinder.Eval(Container.DataItem, "CountUnit")%>|<%#DataBinder.Eval(Container.DataItem, "Model")%>|<%#DataBinder.Eval(Container.DataItem, "Stockmoney")%>|<%#DataBinder.Eval(Container.DataItem, "Color")%>'>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:BoundColumn DataField="GoodsName" HeaderText="商品名"></asp:BoundColumn>
															<asp:BoundColumn DataField="CountUnit" HeaderText="计量单位"></asp:BoundColumn>
															<asp:BoundColumn DataField="Model" HeaderText="规格"></asp:BoundColumn>
															<asp:BoundColumn DataField="Color" HeaderText="颜色"></asp:BoundColumn>
															<asp:BoundColumn DataField="Area" HeaderText="产地"></asp:BoundColumn>
														</Columns>
