<%@ Page language="c#" Codebehind="Cgfk_WorkStreamName_add_pdzj.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Cgfk_WorkStreamName_add_pdzj" %>
								...
								<td vAlign="top" bgColor="#f3f8fe">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0" id="Table6">
										<tr bgColor="#f3f8fe">
											...
											<td width="85%"><asp:textbox id="Name_Jd" runat="server" Width="100%" ></asp:textbox><A href="JavaScript:void(0)"></A></td>
										</tr>
										<tr bgColor="#f3f8fe">
