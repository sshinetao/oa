<%@ Page language="c#" Codebehind="BB_GoodsData_HW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_GoodsData_HW" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" align="center" border="0">
				<tr>
					...
					<TD style="WIDTH: 45px"><FONT face="宋体">类别：</FONT></TD>
					<TD style="WIDTH: 125px"><asp:textbox id="Type" runat="server" Width="120px"></asp:textbox></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn HeaderText="采购入库量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn HeaderText="采购退货量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn HeaderText="销售出库量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn HeaderText="销售退货量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn HeaderText="其他入库量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn HeaderText="其他出库量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
