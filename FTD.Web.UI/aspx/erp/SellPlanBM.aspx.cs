...
namespace qpsmartweb_jxc
{
	...
	/// SellPlanBM 的摘要说明。
	/// </summary>
	public class SellPlanBM : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from SellPlanBM where  Unit like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'   order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from SellPlanBM order  by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("SellPlanBM.aspx?str="+tilte.Text+"");
		}
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string SQL_Del = "Delete from SellPlanBM where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
				...
				if(Request.QueryString["str"]!=null)
				{
					string SQL_GetList_xs    =  "select * from SellPlanBM where  Unit like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'  and Username='"+this.Session["username"]+"'  order by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
				...
				{
					string SQL_GetList_xs    =  "select * from SellPlanBM  where Username='"+this.Session["username"]+"' order  by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
				}
		...
		private void Imagebutton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellPlanBM_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton9_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellPlanBM_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		{
			Response.Redirect("SellPlanBM_add.aspx");
		}
		...
		private void Imagebutton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellPlanBM   set State='完毕' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					...
					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[完毕]');window.location.href='SellPlanBM.aspx'</script>");
				}
		...
		private void Imagebutton8_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellPlanBM   set State='作废' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					
					List.ExeSql(SQL_Del);//计划



					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[作废]');window.location.href='SellPlanBM.aspx'</script>");
				}
