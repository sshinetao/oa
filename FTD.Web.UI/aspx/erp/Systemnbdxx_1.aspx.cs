...
namespace bjoa
{
	...
	/// Systemnbdxx_1 的摘要说明。
	/// </summary>
	public class Systemnbdxx_1 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from nbdxx where (acceptusername='"+this.Session["userName"]+"' or acceptusername='"+this.Session["worknum"]+"')  and sfck='是' order by id desc";
