...
namespace qpsmartweb_jxc
{
	...
	/// main_db 的摘要说明。
	/// </summary>
	public class main_db : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				Label2.Text=null;
				Label2.Text+="<tr bgColor=#f3f8fe><td align=center><a href=StockOrder_sp.aspx>您有<font color=red>"+alldelpoint_gw+"</font>条采购订单等待审批</a></td></tr>";
			}
			...
			else
			{
				...
				Label6.Text=null;
				Label6.Text+="<tr bgColor=#f3f8fe><td align=center><a href=StockIncome_sp.aspx>您有<font color=red>"+alldelpoint_gzjh+"</font>条采购入库记录等待审批</a></td></tr>";
			...
			else
			{
				...
				Label7.Text=null;
				Label7.Text+="<tr bgColor=#f3f8fe><td align=center><a href=StockOut_sp.aspx>您有<font color=red>"+alldelpoint_zzjh+"</font>条采购退货记录等待审批</a></td></tr>";
			...
			else
			{
				...
				Label8.Text=null;
				Label8.Text+="<tr bgColor=#f3f8fe><td align=center><a href=StockOutMoney_sp.aspx>您有<font color=red>"+alldelpoint_sphys+"</font>条采购付款等待审批</a></td></tr>";
			...
			else
			{
				...
				Label3.Text=null;
				Label3.Text+="<tr bgColor=#f3f8fe><td align=center><a href=SellOrder_sp.aspx>您有<font color=red>"+alldelpoint_1+"</font>条销售订单等待记录审批</a></td></tr>";
			}
			...
			else
			{
				...
				Label4.Text=null;
				Label4.Text+="<tr bgColor=#f3f8fe><td align=center><a href=SellOut_sp.aspx>您有<font color=red>"+alldelpoint_2+"</font>条销售出库记录等待审批</a></td></tr>";
			...
			else
			{
				...
				Label5.Text=null;
				Label5.Text+="<tr bgColor=#f3f8fe><td align=center><a href=SellQuit_sp.aspx>您有<font color=red>"+alldelpoint_3+"</font>条销售退货记录等待审批</a></td></tr>";
			...
			else
			{
				...
				Label9.Text=null;
				Label9.Text+="<tr bgColor=#f3f8fe><td align=center><a href=SellInMoney_sp.aspx>您有<font color=red>"+alldelpoint_4+"</font>条销售收款记录等待审批</a></td></tr>";
			...
			else
			{
				...
				Label10.Text=null;
				Label10.Text+="<tr bgColor=#f3f8fe><td align=center><a href=IncomeRoom_sp.aspx>您有<font color=red>"+alldelpoint_5+"</font>条入库记录等待审批</a></td></tr>";
			...
			else
			{
				...
				Label11.Text=null;
				Label11.Text+="<tr bgColor=#f3f8fe><td align=center><a href=OutRoom_sp.aspx>您有<font color=red>"+alldelpoint_6+"</font>条出库记录等待审批</a></td></tr>";
