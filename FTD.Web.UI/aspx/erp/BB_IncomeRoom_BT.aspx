<%@ Page language="c#" Codebehind="BB_IncomeRoom_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_IncomeRoom_BT" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						<TD style="WIDTH: 64px"><FONT face="宋体">入库来源：</FONT></TD>
						<TD style="WIDTH: 111px"><asp:TextBox id="InSource" runat="server" Width="88px" ></asp:TextBox><A href="javascript:void(0)"><IMG onclick="jsOpen();" alt="" src="image/FDJ.gif" border="0"></A></TD>
						<TD style="WIDTH: 52px"><FONT face="宋体">仓管：</FONT></TD>
						<TD style="WIDTH: 101px"><asp:textbox id="StockPeoName" runat="server" Width="88px"></asp:textbox></TD>
						<TD style="WIDTH: 61px"><FONT face="宋体">收料日期：</FONT></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" BorderWidth="1px"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="InSource" SortExpression="InSource" HeaderText="入库来源">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
