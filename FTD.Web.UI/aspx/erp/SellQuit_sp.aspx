<%@ Page language="c#" Codebehind="SellQuit_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellQuit_sp" %>
				...
				<TBODY>
					<TR>
						<TD style="WIDTH: 85px"><FONT face="宋体">标题关键字：</FONT></TD>
                            ...
                            <asp:ListItem Value="ShTime">退货日期</asp:ListItem>
                            <asp:ListItem Value="Storeroom">收货仓</asp:ListItem>
                            <asp:ListItem Value="CompanyName">客户名称</asp:ListItem>
                            <asp:ListItem Value="StockPeoName">经办人姓名</asp:ListItem>
                            </asp:DropDownList></TD>
						...
						<TD><asp:imagebutton id="ImageButton2" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT>
							...
							<asp:imagebutton id="Imagebutton4" runat="server" ImageUrl="i_blue/ysp.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT><FONT face="宋体">&nbsp;</FONT><asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton></TD>
					</TR>
				</TBODY>
			</TABLE>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="Storeroom" SortExpression="Storeroom" HeaderText="收货仓">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
