<%@ Page language="c#" Codebehind="BB_SellQuote_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_SellQuote_BT" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						<TD style="WIDTH: 63px"><FONT face="宋体">标题：</FONT></TD>
					...
					<TR>
						<TD style="WIDTH: 63px"><FONT face="宋体">发票类型：</FONT></TD>
						<TD style="WIDTH: 93px"><asp:TextBox id="InvoiceType" runat="server" Width="88px"></asp:TextBox></TD>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="InvoiceType" SortExpression="Type" HeaderText="发票类型">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="QdTime" SortExpression="QdTime" HeaderText="预计签订日期" DataFormatString="{0:yyyy-M-dd}">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="OrderAdd" SortExpression="OrderAdd" HeaderText="预计签订地点">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												...
												<asp:BoundColumn DataField="unit" HeaderText="所属部门">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
