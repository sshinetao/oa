<%@ Page language="c#" Codebehind="StockOutMoney_ysp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOutMoney_ysp" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						<TD style="WIDTH: 119px"><FONT face="宋体">订单标题关键字：</FONT></TD>
