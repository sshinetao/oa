...
{
	/// <summary>
	/// BB_StockOut_BT 的摘要说明。
	/// </summary>
	public class BB_StockOut_BT : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from StockOut where 1=1 "+Server.UrlDecode(Request.QueryString["str"])+" ";
		...
		{
			Response.Redirect("BB_StockOut_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_StockOut_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
