<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockPlan_add_add2.aspx.cs" Inherits="qpsmartweb_jxc.StockPlan_add_add2" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;新增生产计划明细
								</td>
							</tr>
						</table>
					</td>
							...
							<TR>
								<td background="i_blue/third_head_bg1.jpg">
									<table id="Table8" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td width="39%">&nbsp;</td>
											<td width="9%"><asp:imagebutton id="ImageButton1" runat="server" ImageUrl="i_blue/ok.jpg" onmouseover="selstr()" OnClick="ImageButton1_Click"></asp:imagebutton></td>
