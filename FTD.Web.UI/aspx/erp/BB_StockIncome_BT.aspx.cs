...
{
	/// <summary>
	/// BB_StockIncome_BT 的摘要说明。
	/// </summary>
	public class BB_StockIncome_BT : System.Web.UI.Page
	{
		...
		public string CreateMidSql()
		{
			...
			if (this.Balance.Text.Trim() != "")
			{
				MidSql=MidSql+" and Balance = '"+this.Balance.Text.Trim()+"'";
			}
			...
			if (this.ShTime.Text.Trim() != "" )
			{
				MidSql=MidSql+" and convert(char(10),cast(ShTime as datetime),120)=convert(char(10),cast('"+this.ShTime.Text+"' as datetime),120) ";
			}	
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from StockIncome where 1=1 "+Server.UrlDecode(Request.QueryString["str"])+" ";
		...
		{
			Response.Redirect("BB_StockIncome_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_StockIncome_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
