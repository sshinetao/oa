...
namespace qpsmartweb_jxc
{
	...
	/// BalanceSet 的摘要说明。
	/// </summary>
	public class BalanceSet : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from BalanceSet order by id desc";
		...
		{
			Response.Redirect("BalanceSet_add.aspx");
		}
		...
		private void ImageButton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('删除[结算方式设置]','结算方式设置','"+this.Session["username"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
				List.ExeSql(sql_insert_xtrz);


				string SQL_Del = "Delete from BalanceSet where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BalanceSet_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
