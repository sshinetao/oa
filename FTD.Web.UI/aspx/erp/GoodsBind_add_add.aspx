<%@ Page language="c#" Codebehind="GoodsBind_add_add.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsBind_add_add" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;新增货物捆绑明细&nbsp;
								</td>
							</tr>
						</table>
					</td>
