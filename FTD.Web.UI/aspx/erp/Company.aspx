...
<%@ Page language="c#" Codebehind="Company.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Company" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" border="0" align="center">
				<tr>
					<td vAlign="middle" width="90%"><FONT face="宋体"><asp:ImageButton id="ImageButton4" runat="server" ImageUrl="i_blue/insert.jpg"></asp:ImageButton>&nbsp;
							<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton5" runat="server" ImageUrl="i_blue/xiugai.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton6" runat="server" ImageUrl="i_blue/shanchu.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:ImageButton></FONT></td>
				</tr>
			</table>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Type" SortExpression="Type" HeaderText="分类"></asp:BoundColumn>
											<asp:BoundColumn DataField="Linkman" SortExpression="Linkman" HeaderText="联系人"></asp:BoundColumn>
											<asp:BoundColumn DataField="Deputy" SortExpression="Deputy" HeaderText="法人代表"></asp:BoundColumn>
										</Columns>
