<%@ Page language="c#" Codebehind="GoodsData_MX_KJ.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsData_MX_KJ" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" align="center" border="0">
				<tr>
					...
					<TD style="WIDTH: 87px"><asp:textbox id="Storeroom" runat="server" Width="80px"></asp:textbox></TD>
					<td vAlign="middle"><FONT face="宋体"><asp:imagebutton id="Imagebutton8" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton4" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="Imagebutton9" runat="server" ImageUrl="i_blue/anhuowu.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="Imagebutton7" runat="server" ImageUrl="i_blue/ankufang.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton5" runat="server" ImageUrl="i_blue/kujing.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton></FONT></td>
				</tr>
			</table>
