<%@ Page language="c#" Codebehind="StockOrder_sp_check.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOrder_sp_check" %>
				...
				<tr>
					...
					<td vAlign="top" width="95%">
						...
						<asp:TextBox id="Gusername" runat="server"  Visible="False"></asp:TextBox><FONT face="宋体">
							...
							<asp:TextBox id="username" runat="server" style="DISPLAY: none"></asp:TextBox></FONT>
					</td>
				</tr>
			</table>
