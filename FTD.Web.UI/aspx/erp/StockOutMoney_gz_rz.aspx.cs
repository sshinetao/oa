...
{
	/// <summary>
	/// StockOutMoney_gz_rz 的摘要说明。
	/// </summary>
	public class StockOutMoney_gz_rz : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from StockOutMoneylog_lc  where KeyField='"+Request.QueryString["number"]+"' order by id desc";
		...
		{
			Response.Redirect("StockOutMoney_gz.aspx?id="+Request.QueryString["id"].ToString()+"");
		}
