...
{
	/// <summary>
	/// BB_IncomeRoom_BT 的摘要说明。
	/// </summary>
	public class BB_IncomeRoom_BT : System.Web.UI.Page
	{
		...
		public string CreateMidSql()
		{
			...
			if (this.InSource.Text.Trim() != "")
			{
				MidSql=MidSql+" and InSource = '"+this.InSource.Text.Trim()+"'";
			}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from IncomeRoom where 1=1 "+Server.UrlDecode(Request.QueryString["str"])+" ";
			...
			else
			{
				...
				string SQL_GetList_xs    =  "select * from IncomeRoom order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();	
		...
		{
			Response.Redirect("BB_IncomeRoom_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_IncomeRoom_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
