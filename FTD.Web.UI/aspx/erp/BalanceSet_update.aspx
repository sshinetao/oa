<%@ Page language="c#" Codebehind="BalanceSet_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BalanceSet_update" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="BalanceSet.aspx">结算方式设置</A>&nbsp;&gt;&gt; 
									修改结算方式设置</td>
							</tr>
						</table>
					</td>
