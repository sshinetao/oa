<%@ Page language="c#" Codebehind="SellQuit_add_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellQuit_add_update" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;修改销售退货明细
								</td>
							</tr>
						</table>
					</td>
									...
									<table id="Table6" cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td align="right" width="15%"><FONT face="宋体">销售单价：</FONT></td>
												<td width="35%"><asp:textbox onkeypress="var k=event.keyCode; return (k>=48&amp;&amp;k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData('text'))"
														id="SingleMoney" ondragenter="return false" style="IME-MODE: disabled" runat="server" Width="100%" onmouseout="selstr()">0</asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
