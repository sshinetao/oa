...
{
	/// <summary>
	/// StockIncome_gz 的摘要说明。
	/// </summary>
	public class StockIncome_gz : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				...
				if(NewReader.Read())
				{
					...
					Type.Text=NewReader["State"].ToString();
			...
			string    SQL_Label2     =   "select  * from Cgrk_WorkStreamName where KeyFile='"+StreamNumber.Text+"' order by id asc";
		...
		{
			Response.Redirect("StockIncome_gz_rz.aspx?number="+Number.Text+"&id="+Request.QueryString["id"].ToString()+"");
		}
	}
}
