...
<%@ Page language="c#" Codebehind="StockReady_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockReady_show" %>
									...
									<table id="Table6" cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="GoodsNumber" runat="server" Width="100%" ></asp:textbox></td>
