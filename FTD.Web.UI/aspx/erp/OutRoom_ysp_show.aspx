...
<%@ Page language="c#" Codebehind="OutRoom_ysp_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OutRoom_ysp_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="OutRoom_sp.aspx">我审批的出库</A>&nbsp;&gt;&gt; 
									查看我审批的出库</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%">
													<asp:textbox id="ThTime" runat="server" Width="100%" DataType="DateTime" ></asp:textbox>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%" style="HEIGHT: 33px"><asp:textbox id="Storeroom" runat="server" Width="100%" ></asp:textbox>
												</td>
												<td align="right" style="HEIGHT: 33px">出库用途</td>
												<td style="HEIGHT: 33px"><asp:textbox id="OutUse" runat="server" Width="100%" ></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
											...
											<tr bgColor="#f3f8fe">
												...
												<td style="HEIGHT: 33px" width="35%"><asp:textbox id="Realname" runat="server" Width="100%" ></asp:textbox></td>
												<td style="HEIGHT: 33px" align="right"><FONT face="宋体">我的操作：</FONT></td>
												<td style="HEIGHT: 33px"><asp:textbox id="SpCz" runat="server" Width="100%" ></asp:textbox><A href="javascript:void(0)"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right"><FONT face="宋体">审批备注：</FONT></td>
												<td colSpan="3"><asp:textbox id="Sreakmart" runat="server" Width="100%" Height="52px" TextMode="MultiLine" ></asp:textbox><A href="javascript:void(0)"></A></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
