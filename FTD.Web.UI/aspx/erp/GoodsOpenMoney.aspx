<%@ Page language="c#" Codebehind="GoodsOpenMoney.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsOpenMoney" %>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="Zhekou" SortExpression="Zhekou" HeaderText="折扣"></asp:BoundColumn>
