...
<%@ Page language="c#" Codebehind="SellQuit_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellQuit_update" %>
		 ...
		 function del()
		  {
			...
			else
			{
				 ...
				 window.showModalDialog("open_SellOrder_out.aspx?tmp="+num+"&number="+number+"&CompanyNumber="+CompanyNumber+"","window","dialogWidth:700px;DialogHeight=600px;status:no;scroll=yes;help:no");			
			}
            ...
            var num=Math.random();
            var number=document.getElementById('number').value;
           window.showModalDialog("SellQuit_add_add.aspx?tmp="+num+"&number="+number+" ","window","dialogWidth:700px;DialogHeight=400px;status:no;scroll=yes;help:no");                
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="SellQuit.aspx">销售退货</A>&nbsp;&gt;&gt; 
									修改销售退货</td>
							</tr>
						</table>
					</td>
...
document.getElementById("StockPeoNum").value=arr[2]; 
        ...
        function  splc()  
            {  
            var num=Math.random();
                wName_5=window.showModalDialog("open_Xsth_stream.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");                
