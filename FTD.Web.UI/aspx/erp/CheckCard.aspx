<%@ Page language="c#" Codebehind="CheckCard.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.CheckCard" %>
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" align="center" border="0">
				<tr>
					...
					<td vAlign="middle"><FONT face="宋体">
							<asp:imagebutton id="Imagebutton8" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton4" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="Imagebutton9" runat="server" ImageUrl="i_blue/pandian.jpg"></asp:imagebutton>&nbsp;
							<asp:imagebutton id="Imagebutton1" runat="server" ImageUrl="i_blue/pandianmx.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton></FONT></td>
				</tr>
			</table>
