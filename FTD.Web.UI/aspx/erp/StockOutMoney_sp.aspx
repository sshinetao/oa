<%@ Page language="c#" Codebehind="StockOutMoney_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOutMoney_sp" %>
					...
					<TR>
						<TD style="WIDTH: 119px"><FONT face="宋体">关键字：</FONT></TD>
                            ...
                            <asp:DropDownList runat="server" ID="selectList">
                                ...
                                <asp:ListItem Value="Outtime">付款日期</asp:ListItem>
                                <asp:ListItem Value="IncomeSet">付款方式</asp:ListItem>
                                <asp:ListItem Value="FkMoney">付款金额</asp:ListItem>
