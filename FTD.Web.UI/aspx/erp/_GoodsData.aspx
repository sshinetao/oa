<%@ Page language="c#" Codebehind="_GoodsData.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsData" %>
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" align="center" border="0">
				<tr>
					<td vAlign="middle" width="90%"><FONT face="宋体">
                        ...
                        &nbsp;
                        <asp:imagebutton id="ImageButton4" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton>
                        &nbsp;
                        <asp:imagebutton id="ImageButton6" runat="server" ImageUrl="i_blue/xiugai.jpg"></asp:imagebutton>
                        &nbsp;
						...
						<table height="135" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td vAlign="top">
                                    ...
                                    <uc1:PageNavigator runat="server" id="PageNavigator" />
