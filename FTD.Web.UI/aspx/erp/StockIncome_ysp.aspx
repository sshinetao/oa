<%@ Page language="c#" Codebehind="StockIncome_ysp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockIncome_ysp" %>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="SpCz" SortExpression="SpCz" HeaderText="操作"></asp:BoundColumn>
