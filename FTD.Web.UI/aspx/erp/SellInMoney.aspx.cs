...
namespace qpsmartweb_jxc
{
	...
	/// SellInMoney 的摘要说明。
	/// </summary>
	public class SellInMoney : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
                string SQL_GetList_xs = "select * from SellInMoney where  " + Server.UrlDecode(Request.QueryString["keywords"]) + " like '%" + Server.UrlDecode(Request.QueryString["str"]) + "%'  and Username='" + this.Session["username"] + "'  order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from SellInMoney  where Username='"+this.Session["username"]+"'order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
            Response.Redirect("SellInMoney.aspx?str=" + tilte.Text + "&keywords=" + sellquitSelect.SelectedValue);
		}

		private void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			Response.Redirect("SellInMoney_add.aspx");
		}
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				string SQL_Del = "Delete from SellInMoney where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
				...
				if(Request.QueryString["str"]!=null)
				{
					string SQL_GetList_xs    =  "select * from SellInMoney where  title like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'   order by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
				...
				{
					string SQL_GetList_xs    =  "select * from SellInMoney order by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
				}
		...
		private void Imagebutton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellInMoney_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton8_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellInMoney_gz.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton9_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellInMoney_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
