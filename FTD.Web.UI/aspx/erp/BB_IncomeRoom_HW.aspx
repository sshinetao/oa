...
<%@ Page language="c#" Codebehind="BB_IncomeRoom_HW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_IncomeRoom_HW" %>
					...
					<TR>
						<TD style="WIDTH: 44px"><FONT face="宋体">
                             <asp:DropDownList runat="server" ID="ddl">
                                ...
                                <asp:ListItem Text="来源村" Value="Model" />
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="StockPoint" SortExpression="StockPoint" HeaderText="数量">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
