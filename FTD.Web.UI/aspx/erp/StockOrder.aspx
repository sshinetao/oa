...
<%@ Page language="c#" Codebehind="StockOrder.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOrder" %>
					...
					<TR>
						<TD style="WIDTH: 143px"><FONT face="宋体">标题关键字：</FONT></TD>
                         <td style="WIDTH: 143px">
                            <asp:DropDownList runat="server" ID="selectList">
                                <asp:ListItem Value="tilte">标题</asp:ListItem>
                                <asp:ListItem Value="QdTime">签订日期</asp:ListItem>
                                <asp:ListItem Value="CompanyName">供应商名称</asp:ListItem>
                                <asp:ListItem Value="StockPeoName">采购员姓名</asp:ListItem>
						...
						<TD><asp:imagebutton id="ImageButton2" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT>
							...
							<asp:imagebutton id="Imagebutton5" runat="server" ImageUrl="i_blue/shanchu.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;
								...
								<asp:imagebutton id="Imagebutton7" runat="server" ImageUrl="i_blue/zuofei.jpg"></asp:imagebutton>&nbsp;
								<asp:imagebutton id="Imagebutton8" runat="server" ImageUrl="i_blue/liuchenggenz.jpg"></asp:imagebutton>&nbsp;</FONT><asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton>
                            &nbsp;
                            
                             <asp:imagebutton id="ImageButton10" runat="server" ImageUrl="i_blue/daorudingdan.jpg" OnClick="ImageButton6_Click"></asp:imagebutton>
