...
<%@ Page language="c#" Codebehind="PostType.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.PostType" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Number" SortExpression="Number" HeaderText="组织代码"></asp:BoundColumn>
											<asp:BoundColumn DataField="Name" SortExpression="Name" HeaderText="组织名称"></asp:BoundColumn>
											<asp:BoundColumn DataField="Content" SortExpression="Content" HeaderText="主要工作内容"></asp:BoundColumn>
										</Columns>
