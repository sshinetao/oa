<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shengchanshishi_add.aspx.cs"  Inherits="FTD.Web.UI.aspx.erp.shengchanshishi_add" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="zhongzhipinming" runat="server" Width="100%"></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="yujichanliang" runat="server" Width="100%"></asp:textbox></td>
                                                </tr>
                                            <tr bgColor="#f3f8fe">
                                                <td align="right" width="15%"><FONT face="宋体">收购价格：</FONT></td>
												<td width="35%"><asp:textbox id="shougoujiage" runat="server" Width="100%"></asp:textbox></td>
                                                </tr>
                                            <tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="caishoushijian" runat="server" Width="100%"  DataType="DateTime" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})"></asp:textbox></td>
							</tr>
						</table>
