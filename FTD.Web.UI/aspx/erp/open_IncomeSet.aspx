<%@ Page language="c#" Codebehind="open_IncomeSet.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_IncomeSet" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%" class="headfont">收付款方式</td>
							</tr>
						</table>
					</td>
											...
											<td width="100%"><FONT face="宋体">
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															...
															<asp:BoundColumn DataField="Name" HeaderText="收付款方式"></asp:BoundColumn>
														</Columns>
