<%@ Page language="c#" Codebehind="BB_OutRoom_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_OutRoom_BT" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						...
						<TD style="WIDTH: 101px"><asp:textbox id="Storeroom" runat="server" Width="72px" ></asp:textbox><A href="javascript:void(0)"><IMG onclick="jhcOpen();" alt="" src="image/FDJ.gif" border="0"></A></TD>
					...
					<TR>
						<TD style="WIDTH: 64px"><FONT face="宋体">出库用途：</FONT></TD>
						<TD style="WIDTH: 111px"><asp:TextBox id="OutUse" runat="server" Width="88px" ></asp:TextBox><A href="javascript:void(0)"><IMG onclick="jsOpen();" alt="" src="image/FDJ.gif" border="0"></A></TD>
						<TD style="WIDTH: 52px"><FONT face="宋体">提货人：</FONT></TD>
						<TD style="WIDTH: 101px"><asp:textbox id="ThPeople" runat="server" Width="88px"></asp:textbox></TD>
						<TD style="WIDTH: 61px"><FONT face="宋体">提货日期：</FONT></TD>
						<TD style="WIDTH: 111px"><asp:TextBox id="ThTime" runat="server" Width="80px" ></asp:TextBox>
							<script>SetNeed('ThTime')</script>
									...
									src="image/FDJ.gif" border="0"></A></TD>
						<TD colspan="3"><FONT face="宋体"><asp:imagebutton id="Imagebutton1" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton>&nbsp;
								<asp:imagebutton id="Imagebutton3" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton></FONT></TD>
						<TD></TD>
					</TR>
				</TBODY>
			</TABLE>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" BorderWidth="1px"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="ThTime" SortExpression="ThTime" HeaderText="提货日期" DataFormatString="{0:yyyy-M-dd}">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="ThPeople" SortExpression="ThPeople" HeaderText="提货人">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="Tel" SortExpression="Tel" HeaderText="提货人电话">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												...
												<asp:BoundColumn DataField="OutUse" SortExpression="OutUse" HeaderText="出库用途">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
