<%@ Page language="c#" Codebehind="SellPlanHW_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellPlanHW_show" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%">
													<asp:textbox id="GoodsName" runat="server" Width="100%" ></asp:textbox></td>
