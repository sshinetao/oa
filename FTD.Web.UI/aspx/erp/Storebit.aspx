...
<%@ Page language="c#" Codebehind="Storebit.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Storebit" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Number" SortExpression="Number" HeaderText="编号"></asp:BoundColumn>
											<asp:BoundColumn DataField="Name" SortExpression="Name" HeaderText="名称"></asp:BoundColumn>
											<asp:BoundColumn DataField="Storeroom" SortExpression="Storeroom" HeaderText="所属库房名称"></asp:BoundColumn>
										</Columns>
