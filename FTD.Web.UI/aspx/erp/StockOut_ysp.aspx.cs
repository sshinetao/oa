...
namespace qpsmartweb_jxc
{
	...
	/// StockOut_ysp 的摘要说明。
	/// </summary>
	public class StockOut_ysp : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from StockOut_sp where  title like '%"+Server.UrlDecode(Request.QueryString["str"])+"%' and Spusername='"+this.Session["username"]+"'     order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from StockOut_sp  where  Spusername='"+this.Session["username"]+"'     order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		private void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("StockOut_ysp_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				string SQL_Del = "Delete from StockOut_sp where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		{
			Response.Redirect("StockOut_ysp.aspx?str="+tilte.Text+"");
		}
