<%@ Page language="c#" Codebehind="Cgth_WorkStreamName_add_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Cgth_WorkStreamName_add_update" %>
								...
								<td vAlign="top" bgColor="#f3f8fe">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0" id="Table6">
										...
										<tr bgColor="#f3f8fe">
											...
											<td>
												<asp:textbox id="realname" runat="server" Width="100%" ></asp:textbox><A href="JavaScript:void(0)"></A></td>
										</tr>
									</table>
