<%@ Page language="c#" Codebehind="SystemLog.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SystemLog" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" align="center" border="0">
				<tr>
					<td vAlign="middle" width="90%"><FONT face="宋体"><asp:imagebutton id="ImageButton1" runat="server" ImageUrl="i_blue/gjcx.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton2" runat="server" ImageUrl="i_blue/shanchu.jpg"></asp:imagebutton>&nbsp;<asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton></FONT></td>
				</tr>
			</table>
				...
				<tr>
					...
					<td vAlign="top" width="95%">
						<table height="135" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td vAlign="top">
									<asp:datagrid id="Datagrid2" runat="server" BorderWidth="2px" GridLines="Vertical" BackColor="White"
										BorderStyle="None" Width="100%" AutoGenerateColumns="False" BorderColor="#6595D6" CellPadding="3"
										PageSize="12" OnPageIndexChanged="MyDataGrid_Page_1" AllowPaging="True" AllowSorting="True">
