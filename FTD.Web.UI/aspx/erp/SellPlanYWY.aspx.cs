...
namespace qpsmartweb_jxc
{
	...
	/// SellPlanYWY 的摘要说明。
	/// </summary>
	public class SellPlanYWY : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from SellPlanYWY where  SellsName like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'   order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from SellPlanYWY order  by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("SellPlanYWY.aspx?str="+tilte.Text+"");
		}
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string SQL_Del = "Delete from SellPlanYWY where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void Imagebutton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellPlanYWY_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton9_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellPlanYWY_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		{
			Response.Redirect("SellPlanYWY_add.aspx");
		}
		...
		private void Imagebutton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellPlanYWY   set State='完毕' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					...
					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[完毕]');window.location.href='SellPlanYWY.aspx'</script>");
				}
		...
		private void Imagebutton8_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				{
					string SQL_Del = "update  SellPlanYWY   set State='作废' where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
					
					List.ExeSql(SQL_Del);//计划



					this.Response.Write("<script language=javascript>alert('提交成功！状态更改为[作废]');window.location.href='SellPlanYWY.aspx'</script>");
				}
