...
<%@ Page language="c#" Codebehind="ReportLose.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.ReportLose" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						<TD style="WIDTH: 53px"><FONT face="宋体">仓库名：</FONT></TD>
                        <td style="WIDTH: 143px">
                         <asp:DropDownList runat="server" ID="selectList">
                                <asp:ListItem Value="Storeroom">仓库名称</asp:ListItem>
                                <asp:ListItem Value="BsTimes">报损日期</asp:ListItem>
                                 <asp:ListItem Value="StockPeoName">报损人</asp:ListItem>
                                <asp:ListItem Value="Realname">录入人</asp:ListItem>
                                <asp:ListItem Value="Remark">摘要</asp:ListItem>
                            </asp:DropDownList></td>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="Storeroom" SortExpression="Storeroom" HeaderText="仓库名称">
												...
												<asp:BoundColumn DataField="StockPeoName" SortExpression="StockPeoName" HeaderText="报损人姓名">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
