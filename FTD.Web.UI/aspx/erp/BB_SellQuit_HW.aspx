...
<%@ Page language="c#" Codebehind="BB_SellQuit_HW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_SellQuit_HW" %>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="title" SortExpression="title" HeaderText="对应退货单">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
											</Columns>
