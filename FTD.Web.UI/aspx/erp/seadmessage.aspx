<%@ Page language="c#" Codebehind="seadmessage.aspx.cs" AutoEventWireup="false" Inherits="bjoa.seadmessage" %>
									...
									<td valign="top" bgcolor="#f3f8fe"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
										...
										<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#d8e1e8">
											<TBODY>
												...
												<tr bgColor="#f3f8fe">
													<td align="right"><FONT face="宋体"><FONT face="宋体"><FONT face="宋体">接受人员</FONT></FONT>：</FONT></td>
													<td><FONT face="宋体">
															<asp:DropDownList id="user" runat="server" Width="100%"></asp:DropDownList></FONT></td>
												</tr>
								</tr>
							</TBODY>
						</table>
							...
							<tr>
								<td background="i_blue/third_head_bg1.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="52%">&nbsp; <a href="javascript:window.close()"><IMG alt="" src="i_blue/close.jpg" border="0"></a></td>
										</tr>
									</table>
								</td>
							</tr>
