...
{
	/// <summary>
	/// Cgdd_WorkStreamJd 的摘要说明。
	/// </summary>
	public class Cgdd_WorkStreamJd : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from Cgdd_WorkStreamJd order by id desc";
		...
		private void ImageButton2_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string SQL_Del = "Delete from Cgdd_WorkStreamJd  where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		{
			Response.Redirect("Cgdd_WorkStreamJd_add.aspx");
		}
		...
		private void ImageButton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("Cgdd_WorkStreamJd_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
