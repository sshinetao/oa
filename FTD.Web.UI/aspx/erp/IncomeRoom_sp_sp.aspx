<%@ Page language="c#" Codebehind="IncomeRoom_sp_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.IncomeRoom_sp_sp" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="IncomeRoom_sp.aspx">入库审批</A>&nbsp;&gt;&gt; 
									入库审批</td>
							</tr>
						</table>
					</td>
								...
								<td background="i_blue/third_head_bg1.jpg">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td width="39%">&nbsp;</td>
											<td width="9%">
												<asp:ImageButton id="ImageButton3" runat="server" ImageUrl="i_blue/ok.jpg"></asp:ImageButton></td>
