...
<%@ Page language="c#" Codebehind="_OutRoom.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OutRoom" %>
					...
					<TR>
						...
						<TD><asp:imagebutton id="ImageButton2" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT>
							...
							<asp:imagebutton id="Imagebutton5" runat="server" ImageUrl="i_blue/shanchu.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;
								<asp:imagebutton id="Imagebutton8" runat="server" ImageUrl="i_blue/liuchenggenz.jpg"></asp:imagebutton>&nbsp;


							                                                                                                  </FONT>
                            <asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="ThPeople" SortExpression="StockPeoName" HeaderText="提货人">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
