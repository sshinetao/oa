...
namespace qpsmartweb_jxc
{
	...
	/// SellOrder_ysp 的摘要说明。
	/// </summary>
	public class SellOrder_ysp : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from SellOrder_sp where  title like '%"+Server.UrlDecode(Request.QueryString["str"])+"%' and Spusername='"+this.Session["username"].ToString()+"'  order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from SellOrder_sp  where  Spusername='"+this.Session["username"].ToString()+"'    order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("SellOrder_sp.aspx?str="+tilte.Text+"");
		}
		...
		private void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("SellOrder_ysp_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
