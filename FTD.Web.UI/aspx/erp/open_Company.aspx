<%@ Page language="c#" Codebehind="open_Company.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_Company" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%" class="headfont">往来单位</td>
							</tr>
						</table>
					</td>
									...
									<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#d8e1e8">
										<tr bgcolor="#f3f8fe">
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="25%"><FONT face="宋体">单位关键字：</FONT></td>
														<td width="42%">
													...
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															<asp:TemplateColumn>
																...
																<ItemTemplate>
																	&nbsp;<INPUT type="radio"  name="Rad" id="Radio1"  CHECKED value='<%#DataBinder.Eval(Container.DataItem, "Number")%>|<%#DataBinder.Eval(Container.DataItem, "Name")%>|<%#DataBinder.Eval(Container.DataItem, "BankNumber")%>|<%#DataBinder.Eval(Container.DataItem, "TaxNumber")%>|<%#DataBinder.Eval(Container.DataItem, "Bank")%>'>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:BoundColumn DataField="Number" HeaderText="编号"></asp:BoundColumn>
