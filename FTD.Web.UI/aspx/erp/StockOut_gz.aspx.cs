...
namespace qpsmartweb_jxc
{
	...
	/// StockOut_gz 的摘要说明。
	/// </summary>
	public class StockOut_gz : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string    SQL_Label2     =   "select  * from Cgth_WorkStreamName where KeyFile='"+StreamNumber.Text+"' order by id asc";
		...
		{
			Response.Redirect("StockOut_gz_rz.aspx?number="+Number.Text+"&id="+Request.QueryString["id"].ToString()+"");
		}
	}
}
