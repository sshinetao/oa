...
namespace qpsmartweb_jxc
{
	...
	/// GoodsType 的摘要说明。
	/// </summary>
	public class GoodsType : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("GoodsType_add.aspx");
		}
		...
		private void ImageButton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('删除[商品类别]','商品类别','"+this.Session["UserName"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
				List.ExeSql(sql_insert_xtrz);


				string SQL_Del = "Delete from GoodsType where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("GoodsType_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
