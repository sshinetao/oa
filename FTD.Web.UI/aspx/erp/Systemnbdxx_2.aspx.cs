...
namespace bjoa
{
	...
	/// Systemnbdxx_2 的摘要说明。
	/// </summary>
	public class Systemnbdxx_2 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from nbdxx where (sendusername='"+this.Session["userName"]+"' or sendusername='"+this.Session["worknum"]+"') order by id desc";
