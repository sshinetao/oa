<%@ Page language="c#" Codebehind="OutRoom_sp_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OutRoom_sp_sp" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="OutRoom_sp.aspx">出库审批</A>&nbsp;&gt;&gt; 
									出库审批</td>
							</tr>
						</table>
					</td>
