...
<%@ Page language="c#" Codebehind="SellInMoney_sp_check.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellInMoney_sp_check" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td>
													<asp:textbox   id="FkMoney"  runat="server" Width="100%"  >0</asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
											...
											<tr bgColor="#f3f8fe">
												...
												<td><FONT face="宋体">
														<asp:TextBox id="Textbox5" runat="server" Width="100%"></asp:TextBox></FONT></td>
			...
			<asp:TextBox id="Gusername" runat="server"  Visible="False"></asp:TextBox><FONT face="宋体">
				...
				<asp:TextBox id="username" runat="server" style="DISPLAY: none"></asp:TextBox></FONT></TD>
			<td width="15">&nbsp;</td>
