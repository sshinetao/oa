...
{
	/// <summary>
	/// ReportLose_update 的摘要说明。
	/// </summary>
	public class ReportLose_update : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				...
				string    SQL_GetList     =  "select * from ReportLose  where id='" + int.Parse(Request.QueryString["id"])+"'";
		...
		{
			string Sql_update ="Update ReportLose Set Storeroom='"+Storeroom.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',BsTimes='"+BsTimes.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',StockPeoNum='"+StockPeoNum.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',StockPeoName='"+StockPeoName.Text+"',Remark='"+Remark.Text+"',MyTimes='"+this.Session["MyTimes"]+"',Username='"+this.Session["Username"]+"',Realname='"+this.Session["TrueName"]+"' where  id='" + int.Parse(Request.QueryString["id"])+"'";
