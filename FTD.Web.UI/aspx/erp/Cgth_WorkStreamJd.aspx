...
<%@ Page language="c#" Codebehind="Cgth_WorkStreamJd.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Cgth_WorkStreamJd" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Number" HeaderText="节点编号"></asp:BoundColumn>
