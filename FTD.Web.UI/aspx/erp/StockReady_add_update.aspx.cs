...
namespace qpsmartweb_jxc
{
	...
	public class StockReady_add_update : System.Web.UI.Page
	{
		...
		{
			string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('修改[订单备料明细]','订单备料','"+this.Session["username"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
