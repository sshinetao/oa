<%@ Page language="c#" Codebehind="InvoiceType_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.InvoiceType_update" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="InvoiceType.aspx">发票类型</A>&nbsp;&gt;&gt; 
									修改发票类型</td>
							</tr>
						</table>
					</td>
							...
							<tr>
								<td vAlign="top" bgColor="#f3f8fe">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<tr bgColor="#f3f8fe">
											<td align="right" width="15%"><FONT face="宋体">结算方式：</FONT></td>
