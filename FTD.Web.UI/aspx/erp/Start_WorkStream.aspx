...
<%@ Page language="c#" Codebehind="Start_WorkStream.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Start_WorkStream" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" border="0" align="center">
				<tr>
					<td vAlign="middle" width="90%"><FONT face="宋体"><asp:ImageButton id="ImageButton4" runat="server" ImageUrl="i_blue/qiyongjinzhi.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:ImageButton></FONT></td>
				</tr>
			</table>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Name" SortExpression="Name" HeaderText="模块名"></asp:BoundColumn>
											<asp:BoundColumn DataField="IfStart" SortExpression="IfStart" HeaderText="状态"></asp:BoundColumn>
										</Columns>
