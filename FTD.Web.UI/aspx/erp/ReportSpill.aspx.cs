...
namespace qpsmartweb_jxc
{
	...
	/// ReportSpill 的摘要说明。
	/// </summary>
	public class ReportSpill : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from ReportSpill where  Storeroom like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'  and Username='"+this.Session["username"]+"'  order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from ReportSpill  where Username='"+this.Session["username"]+"'order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("ReportSpill.aspx?str="+tilte.Text+"");
		}

		private void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			Response.Redirect("ReportSpill_add.aspx");
		}
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				string SQL_Del = "Delete from ReportSpill where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
				...
				if(Request.QueryString["str"]!=null)
				{
					string SQL_GetList_xs    =  "select * from ReportSpill where  Storeroom like '%"+Server.UrlDecode(Request.QueryString["str"])+"%'   order by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
		...
		private void Imagebutton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("ReportSpill_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton9_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("ReportSpill_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
