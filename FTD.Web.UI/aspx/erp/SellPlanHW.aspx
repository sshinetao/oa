...
<%@ Page language="c#" Codebehind="SellPlanHW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellPlanHW" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						<TD style="WIDTH: 101px"><FONT face="宋体">货物关键字：</FONT></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="GoodsName" SortExpression="GoodsName" HeaderText="货物">
