...
{
	/// <summary>
	/// GoodsOpenMoney_show 的摘要说明。
	/// </summary>
	public class GoodsOpenMoney_show : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				string    SQL_GetList     =  "select * from GoodsOpenMoney  where id='" + int.Parse(Request.QueryString["id"])+"'";
