<%@ Page language="c#" Codebehind="OutRoom_gz.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OutRoom_gz" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td align="right" width="15%"><FONT face="宋体"><FONT face="宋体">出货仓</FONT>：</FONT></td>
												<td width="35%">
