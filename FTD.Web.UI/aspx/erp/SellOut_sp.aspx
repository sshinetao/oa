...
<%@ Page language="c#" Codebehind="SellOut_sp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOut_sp" %>
				...
				<TBODY>
					<TR>
						<TD style="WIDTH: 85px"><FONT face="宋体">标题关键字：</FONT></TD>
                          <TD style="WIDTH: 143px"><asp:DropDownList runat="server" ID="selloutspSelect">
                            ...
                            <asp:ListItem Value="StockPeoName">业务员姓名</asp:ListItem>
                            <asp:ListItem Value="ThPeople">提货人</asp:ListItem>
