<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_Company2.aspx.cs" Inherits="FTD.Web.UI.aspx.erp.open_Company2" %>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="33%"><FONT face="宋体">&nbsp;</FONT>
															<asp:ImageButton id="ImageButton2" runat="server" ImageUrl="i_blue/search.jpg" OnClick="ImageButton2_Click"></asp:ImageButton></td>
													</tr>
												</table>
											</td>
										</tr>
													...
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															<asp:TemplateColumn>
																...
																<ItemTemplate>
																	&nbsp;<INPUT type="radio"  name="Rad" id="Radio1"  CHECKED value='<%#DataBinder.Eval(Container.DataItem, "ID")%>|<%#DataBinder.Eval(Container.DataItem, "Customer")%>|'>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:BoundColumn DataField="ID" HeaderText="编号"></asp:BoundColumn>
															<asp:BoundColumn DataField="Customer" HeaderText="名称"></asp:BoundColumn>
														</Columns>
