<%@ Page language="c#" Codebehind="open_Storeroom.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_Storeroom" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%" class="headfont">库房检索</td>
							</tr>
						</table>
					</td>
									...
									<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#d8e1e8">
										<tr bgcolor="#f3f8fe">
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="25%"><FONT face="宋体">库房关键字：</FONT></td>
														<td width="42%">
											...
											<td width="100%"><FONT face="宋体">
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															...
															<asp:BoundColumn DataField="Name" HeaderText="库房名称"></asp:BoundColumn>
														</Columns>
