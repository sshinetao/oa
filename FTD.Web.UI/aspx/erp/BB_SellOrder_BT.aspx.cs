...
{
	/// <summary>
	/// BB_SellOrder_BT 的摘要说明。
	/// </summary>
	public class BB_SellOrder_BT : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("BB_SellOrder_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_SellOrder_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
