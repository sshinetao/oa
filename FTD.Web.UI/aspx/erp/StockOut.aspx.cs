...
namespace qpsmartweb_jxc
{
	...
	/// StockOut 的摘要说明。
	/// </summary>
	public class StockOut : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
                string SQL_GetList_xs = "select * from StockOut where   " + Server.UrlDecode(Request.QueryString["keywords"]) + " like '%" + Server.UrlDecode(Request.QueryString["str"]) + "%'  and Username='" + this.Session["username"] + "'  order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from StockOut  where Username='"+this.Session["username"]+"'order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("StockOut.aspx?str="+tilte.Text+ "&keywords=" + dl1.SelectedValue);
		}

		private void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			Response.Redirect("StockOut_add.aspx");
		}
		...
		private void Imagebutton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				string SQL_Del = "Delete from StockOut where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
				...
				if(Request.QueryString["str"]!=null)
				{
                    string SQL_GetList_xs = "select * from StockOut where   " + Server.UrlDecode(Request.QueryString["keywords"]) + " like '%" + Server.UrlDecode(Request.QueryString["str"]) + "%'   order by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
				...
				{
					string SQL_GetList_xs    =  "select * from StockOut order by id desc";
					Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
					Datagrid2.DataBind();
				}
		...
		private void Imagebutton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("StockOut_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton8_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("StockOut_gz.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void Imagebutton9_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("StockOut_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
