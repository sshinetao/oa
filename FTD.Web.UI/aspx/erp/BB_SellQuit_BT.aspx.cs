...
{
	/// <summary>
	/// BB_SellQuit_BT 的摘要说明。
	/// </summary>
	public class BB_SellQuit_BT : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from SellQuit where 1=1 "+Server.UrlDecode(Request.QueryString["str"])+" ";
		...
		{
			Response.Redirect("BB_SellQuit_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_SellQuit_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
