...
{
	/// <summary>
	/// StockOutMoney_ysp 的摘要说明。
	/// </summary>
	public class StockOutMoney_ysp : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from StockOutMoney_sp where  title like '%"+Server.UrlDecode(Request.QueryString["str"])+"%' and Spusername='"+this.Session["username"]+"'   order by id desc";
			...
			{
				string SQL_GetList_xs    =  "select * from StockOutMoney_sp  where  Spusername='"+this.Session["username"]+"'   order by id desc";
				Datagrid2.DataSource   = List.GetGrid_Pages(SQL_GetList_xs,"id");
				Datagrid2.DataBind();
			}
		}
		...
		{
			Response.Redirect("StockOutMoney_ysp.aspx?str="+tilte.Text+"");
		}
		...
		private void Imagebutton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("StockOutMoney_ysp_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
