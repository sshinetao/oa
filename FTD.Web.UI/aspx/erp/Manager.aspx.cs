...
namespace qpsmartweb_jxc
{
	...
	public class Manager : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("Manager_add.aspx");
		}
		...
		private void ImageButton2_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				string SQL_Del = "Delete from Manager  where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void ImageButton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("Manager_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
