...
<%@ Page language="c#" Codebehind="BB_SellInMoney_JL.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_SellInMoney_JL" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					...
					<TR>
						<TD style="WIDTH: 64px"><FONT face="宋体">收款方式：</FONT></TD>
						...
						<TD style="WIDTH: 61px"><FONT face="宋体">收款日期：</FONT></TD>
						...
						<table height="135" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td vAlign="top">
									...
									<FONT face="宋体" color="#ff0000"><STRONG>收付金额：<%=yfmoney%></STRONG></FONT><uc1:fenye id="Fenye1" runat="server"></uc1:fenye></td>
							</tr>
						</table>
					</td>
					<td width="15">&nbsp;</td>
