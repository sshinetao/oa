...
{
	/// <summary>
	/// Cgfk_WorkStreamJd_update 的摘要说明。
	/// </summary>
	public class Cgfk_WorkStreamJd_update : System.Web.UI.Page
	{
		...
		{
			string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('修改[采购付款]工作流','节点名称','"+this.Session["username"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
