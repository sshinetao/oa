...
<%@ Page language="c#" Codebehind="OutRoom_ysp.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OutRoom_ysp" %>
				...
				<TBODY>
					<TR>
						...
						<TD><asp:imagebutton id="ImageButton2" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT>
							<asp:imagebutton id="Imagebutton1" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;
								<asp:ImageButton id="ImageButton6" runat="server" ImageUrl="i_blue/shanchu.jpg"></asp:ImageButton>&nbsp;
