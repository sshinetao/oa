<%@ Page language="c#" Codebehind="shengchanshishi.aspx.cs" AutoEventWireup="false" Inherits=" FTD.Web.UI.aspx.erp.shengchanshishi" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table height="30" cellSpacing="0" cellPadding="0" width="98%" border="0" align="center">
				<tr>
					<td vAlign="middle" width="90%"><FONT face="宋体"><asp:ImageButton id="ImageButton4" runat="server" ImageUrl="i_blue/insert.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton5" runat="server" ImageUrl="i_blue/xiugai.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton6" runat="server" ImageUrl="i_blue/shanchu.jpg"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:ImageButton></FONT></td>
				</tr>
			</table>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="zhongzhipinming" SortExpression="zhongzhipinming" HeaderText="种植品名"></asp:BoundColumn>
											<asp:BoundColumn DataField="mianji" SortExpression="mianji" HeaderText="面积"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="yujichanliang" SortExpression="yujichanliang" HeaderText="预计产量"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="hetongjiage" SortExpression="hetongjiage" HeaderText="收购价格"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="zhongzhishijian" SortExpression="zhongzhishijian" HeaderText="种植时间"></asp:BoundColumn>
                                            <asp:BoundColumn DataField="caishoushijian" SortExpression="caishoushijian" HeaderText="预计采收时间"></asp:BoundColumn>
										</Columns>
