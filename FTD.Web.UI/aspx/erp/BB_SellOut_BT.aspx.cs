...
namespace qpsmartweb_jxc
{
	...
	/// BB_SellOut_BT 的摘要说明。
	/// </summary>
	public class BB_SellOut_BT : System.Web.UI.Page
	{
		...
		public string CreateMidSql()
		{
			...
			{
				MidSql=MidSql+" and Type = '"+this.Type.Text.Trim()+"'";
			}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				string SQL_GetList_xs    =  "select * from SellOut where 1=1 "+Server.UrlDecode(Request.QueryString["str"])+" ";
		...
		{
			Response.Redirect("BB_SellOut_BT.aspx?str="+CreateMidSql()+"");
		}
		...
		private void Imagebutton3_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("BB_SellOut_BT_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
