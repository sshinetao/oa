<%@ Page language="c#" Codebehind="Db_WorkStreamName_add_add.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Db_WorkStreamName_add_add" %>
...
<HTML>
	<HEAD>
		...
		window.onerror = killErrors;	
            ...
            {  
				 var num=Math.random();
				 wName=window.showModalDialog("open_Db_WorkStreamJd.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");               
