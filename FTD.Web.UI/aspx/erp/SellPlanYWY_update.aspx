<%@ Page language="c#" Codebehind="SellPlanYWY_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellPlanYWY_update" %>
...
<HTML>
		 ...
		 function del()
		  {
	    	...
	    	if(document.getElementById('SellsName').value=='')
			{
				alert('业务员不能为空');
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="SellPlanYWY.aspx">业务员销售计划</A>&nbsp;&gt;&gt; 
									修改业务员销售计划</td>
							</tr>
						</table>
					</td>
							...
							<tr>
								<td vAlign="top" bgColor="#f3f8fe">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT style="BACKGROUND-COLOR: #f3f8fe">业务员：</FONT></td>
												<td width="35%">
													<asp:textbox id="SellsName" runat="server" Width="90%" ></asp:textbox><A href="javascript:void(0)"><IMG onclick="splc();" alt="" src="image/FDJ.gif" border="0"></A></td>
			...
			<asp:TextBox id="SellsNumber" runat="server" style="DISPLAY: none"></asp:TextBox></TD>
			<td width="15">&nbsp;</td>
			</TR></TBODY></TABLE>
        ...
        function  splc()  
            {  
            var num=Math.random();
                wName_5=window.showModalDialog("open_manage.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");                
...
document.getElementById("SellsName").value=arr[0]; 
document.getElementById("SellsNumber").value=arr[2]; 
}
