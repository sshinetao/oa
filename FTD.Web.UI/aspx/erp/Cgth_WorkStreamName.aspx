<%@ Page language="c#" Codebehind="Cgth_WorkStreamName.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.Cgth_WorkStreamName" %>
...
<HTML>
	<HEAD>
		...
		if(document.getElementById('Name').value=='')
           ...
           window.showModalDialog("Cgth_WorkStreamName_add_add.aspx?tmp="+num+"&number="+number+" ","window","dialogWidth:600px;DialogHeight=330px;status:no;scroll=yes;help:no");                
...
{ 
  var num=Math.random();
window.showModalDialog('Cgth_WorkStreamName_add_update.aspx?id='+id+'&tmp='+num+'','window','dialogWidth:505px;DialogHeight=400px;status:no;help=no;scroll=on');window.location='#'

window.location="Cgth_WorkStreamName.aspx?id=<%=id%>";
}  
...
{ 
  var num=Math.random();
window.showModalDialog('Cgth_WorkStreamName_add_pdzj.aspx?id='+id+'&tmp='+num+'','window','dialogWidth:505px;DialogHeight=400px;status:no;help=no;scroll=on');window.location='#'
 ...
 function del(id)
{
	if (!confirm("确定删除此项吗？"))
		return false;
		window.location="Cgth_WorkStreamName.aspx?id=<%=id%>&del="+id;
}  
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;采购退货审批流程&nbsp; 
									&gt;&gt;&nbsp;<A class="line_b" href="Cgth_stream.aspx">工作流</A>&nbsp;&gt;&gt; 
									设置工作流</td>
							</tr>
						</table>
					</td>
