...
<%@ Page language="c#" Codebehind="BB_StockOrder_HW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_StockOrder_HW" %>
				...
				<TBODY>
					<TR>
						...
						<TD style="WIDTH: 118px">
							<asp:DropDownList id="Stocktype" runat="server" Width="112px">
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="title" SortExpression="title" HeaderText="对应订单">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
											</Columns>
