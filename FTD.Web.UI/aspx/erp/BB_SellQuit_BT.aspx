<%@ Page language="c#" Codebehind="BB_SellQuit_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_SellQuit_BT" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						...
						<TD style="WIDTH: 73px"><FONT face="宋体">库房：</FONT></TD>
						<TD style="WIDTH: 128px"><asp:textbox id="Storeroom" runat="server" Width="88px" ></asp:textbox><A href="javascript:void(0)"><IMG onclick="jhcOpen();" alt="" src="image/FDJ.gif" border="0"></A></TD>
						<TD style="WIDTH: 61px"><FONT face="宋体">开始时间：</FONT></TD>
						<TD style="WIDTH: 125px"><asp:TextBox id="Starttime" runat="server" Width="96px" ></asp:TextBox>
						...
						<TD style="WIDTH: 133px"><asp:TextBox id="Endtime" runat="server" Width="96px" ></asp:TextBox>
					...
					<TR>
						<TD style="WIDTH: 64px"><FONT face="宋体">经办人：</FONT></TD>
						<TD style="WIDTH: 111px"><asp:textbox id="StockPeoName" runat="server" Width="104px"></asp:textbox></TD>
						<TD style="WIDTH: 73px"><FONT face="宋体">退货日期：</FONT></TD>
						<TD style="WIDTH: 128px">
							<asp:TextBox id="ShTime" runat="server" Width="96px" ></asp:TextBox>
						...
						<TD style="WIDTH: 111px" colspan="2"><asp:TextBox id="CompanyName" runat="server" Width="152px"></asp:TextBox></TD>
						<TD style="WIDTH: 133px"></FONT>
							<asp:imagebutton id="Imagebutton1" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT>
							<asp:imagebutton id="Imagebutton3" runat="server" ImageUrl="i_blue/chakan.jpg"></asp:imagebutton></FONT></TD>
						<TD><FONT face="宋体"></FONT></TD>
					</TR>
				</TBODY>
			</TABLE>
			<TABLE cellSpacing="0" cellPadding="0" width="300" border="0" height="5">
				<TR>
					<TD></TD>
				</TR>
			</TABLE>
