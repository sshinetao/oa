...
namespace qpsmartweb_jxc
{
	...
	/// Username 的摘要说明。
	/// </summary>
	public class Username : System.Web.UI.Page
	{
		...
		{
			Response.Redirect("Username_add.aspx");
		}
		...
		private void ImageButton2_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			try
			{
				...
				string SQL_Del = "Delete from Username  where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void ImageButton4_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("Username_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("Username_show.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
