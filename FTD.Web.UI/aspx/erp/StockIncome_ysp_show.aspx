...
<%@ Page language="c#" Codebehind="StockIncome_ysp_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockIncome_ysp_show" %>
		 ...
		 function del()
		  {
            ...
            var num=Math.random();
            var number=document.getElementById('number').value;
           window.showModalDialog("StockIncome_add_add.aspx?tmp="+num+"&number="+number+" ","window","dialogWidth:700px;DialogHeight=400px;status:no;scroll=yes;help:no");                
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="StockIncome_ysp.aspx">我审批的采购入库</A>&nbsp;&gt;&gt; 
									查看采购入库</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><FONT face="宋体"><asp:textbox id="CompanyAdd" runat="server" Width="100%" ></asp:textbox></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
											...
											<tr bgColor="#f3f8fe">
												...
												<td style="HEIGHT: 33px"><asp:textbox id="State" runat="server" Width="100%" ></asp:textbox><A href="javascript:void(0)"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
