...
{
	/// <summary>
	/// OutRoom_add_add 的摘要说明。
	/// </summary>
	public class OutRoom_add_add : System.Web.UI.Page
	{
		...
		private void ImageButton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			string sql_insert="insert into OutRoomMx (Keyfile,GoodsNumber,GoodsName,CountUnit,Model,StockPoint,Username,Realname,Nowtimes) values('"+Request.QueryString["number"]+"','"+GoodsNumber.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"','"+GoodsName.Text+"','"+CountUnit.Text+"','"+Model.Text+"','"+StockPoint.Text+"','"+this.Session["username"].ToString()+"','"+this.Session["TrueName"].ToString()+"','"+System.DateTime.Now.ToString()+"')";
