...
namespace bjoa
{
	...
	/// Systemnbdxx1 的摘要说明。
	/// </summary>
	public class Systemnbdxx1 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from nbdxx where (acceptusername='"+this.Session["userName"]+"' or acceptusername='"+this.Session["worknum"]+"') and sfck='否' order by id desc";
