<%@ Page language="c#" Codebehind="SellOut_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOut_update" %>
		 ...
		 function del()
		  {
            ...
            var num=Math.random();
            var number=document.getElementById('number').value;
           window.showModalDialog("SellOut_add_add.aspx?tmp="+num+"&number="+number+" ","window","dialogWidth:700px;DialogHeight=400px;status:no;scroll=yes;help:no");                
            ...
            {  
				 var num=Math.random();
                 wName_dd=window.showModalDialog("open_OrderType.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");               
             
                 if(wName_dd!=null && wName_dd!= "undefined")
                 {
                   
			    	document.getElementById("Type").value=wName_dd; 
			    	return;
                 }
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="SellOut.aspx">销售出库</A>&nbsp;&gt;&gt; 
									修改销售出库</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="ThStarttime" runat="server" Width="90%"  DataType="DateTime"></asp:textbox>
													<script>SetNeed('ThStarttime')</script>
													</FONT><A href="javascript:void(0)"><IMG id="ThStarttime_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
															src="image/FDJ.gif" border="0"></A></td>
												<td align="right" width="15%"><FONT face="宋体">有效结束时间：</FONT></td>
												<td width="35%"><asp:textbox id="ThEndtime" runat="server" Width="90%"  DataType="DateTime"></asp:textbox>
													<script>SetNeed('ThEndtime')</script>
													</FONT><A href="javascript:void(0)"><IMG id="ThEndtime_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
															src="image/FDJ.gif" border="0"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
...
document.getElementById("StockPeoNum").value=arr[2]; 
        ...
        function  splc()  
            {  
            var num=Math.random();
                wName_5=window.showModalDialog("open_Xsck_stream.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");                
