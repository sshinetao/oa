...
namespace qpsmartweb_jxc
{
	...
	/// OpenBank 的摘要说明。
	/// </summary>
	public class OpenBank : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from OpenBank order by id desc";
		...
		{
			Response.Redirect("OpenBank_add.aspx");
		}
		...
		private void ImageButton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('删除[开户银行]','开户银行','"+this.Session["username"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
				List.ExeSql(sql_insert_xtrz);


				string SQL_Del = "Delete from OpenBank where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("OpenBank_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
