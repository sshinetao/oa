...
<%@ Page language="c#" Codebehind="SellOut.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOut" %>
				...
				<TBODY>
					<TR>
						<TD style="WIDTH: 85px"><FONT face="宋体">标题关键字：</FONT></TD>
                         <TD style="WIDTH: 143px"><asp:DropDownList runat="server" ID="sellorderspSelect">
                            <asp:ListItem Value="title">标题</asp:ListItem>
                            <asp:ListItem Value="ShTime">出货日期</asp:ListItem>
