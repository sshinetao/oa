<%@ Page language="c#" Codebehind="GoodsData_tj.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsData_tj" %>
		...
		<SCRIPT language="javascript">
		  function del()
		  {
			...
			function drjh()
			{
				 ...
				 window.showModalDialog("GoodsData_tj_pl.aspx?tmp="+num+"","window","dialogWidth:750px;DialogHeight=430px;status:no;scroll=yes;help:no");			
				...
				<TBODY>
					<TR>
						...
						<TD>
							...
							<asp:imagebutton id="Imagebutton4" runat="server" ImageUrl="i_blue/tiaojia.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;
							</FONT>
							<asp:imagebutton id="Imagebutton5" runat="server" ImageUrl="i_blue/piliangtiaojia.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT><asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton></TD>
					</TR>
				</TBODY>
			</TABLE>
