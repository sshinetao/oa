...
{
	/// <summary>
	/// Username_update 的摘要说明。
	/// </summary>
	public class Username_update : System.Web.UI.Page
	{
		...
		private void ImageButton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('修改系统用户','用户管理','"+this.Session["username"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
			List.ExeSql(sql_insert_xtrz);



			string Sql_update ="Update Username Set Realname='"+Realname.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',Sex='"+Sex.SelectedValue.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',Unit='"+Unit.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',Email='"+Email.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',Remark='"+Remark.Text.Replace("<","〈").Replace(">","〉").Replace("'","’")+"',Iflogin='"+Iflogin.SelectedValue+"',Firsttime='"+Firsttime.Text+"',Lasttime='"+Lasttime.Text+"',worknum='"+worknum.Text+"'  where id='" + int.Parse(Request.QueryString["id"])+"'";
