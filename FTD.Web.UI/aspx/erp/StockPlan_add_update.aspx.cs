...
namespace qpsmartweb_jxc
{
	...
	public class StockPlan_add_update : System.Web.UI.Page
	{
		...
		{
			string sql_insert_xtrz="insert into SystemLog (Name,MkName,Username,Realname,Nowtimes) values ('修改[采购计划明细]','采购计划','"+this.Session["username"]+"','"+this.Session["TrueName"]+"','"+System.DateTime.Now.ToString()+"')";
