<%@ Page language="c#" Codebehind="_SellOrder.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOrder" %>
					...
					<TR>
						...
						<TD><asp:imagebutton id="ImageButton2" runat="server" ImageUrl="i_blue/search.jpg"></asp:imagebutton><FONT face="宋体">&nbsp;</FONT>
							...
							<asp:imagebutton id="Imagebutton5" runat="server" ImageUrl="i_blue/shanchu.jpg" OnClick="Imagebutton5_Click1"></asp:imagebutton><FONT face="宋体">&nbsp;
								...
								<asp:imagebutton id="Imagebutton8" runat="server" ImageUrl="i_blue/liuchenggenz.jpg"></asp:imagebutton>&nbsp;</FONT>
                            <asp:imagebutton id="ImageButton3" runat="server" ImageUrl="i_blue/back.jpg"></asp:imagebutton>
                             <asp:imagebutton id="ImageButton6" runat="server" ImageUrl="i_blue/daorudingdan.jpg"></asp:imagebutton>
