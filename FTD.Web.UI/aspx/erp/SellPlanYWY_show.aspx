<%@ Page language="c#" Codebehind="SellPlanYWY_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellPlanYWY_show" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%">
													<asp:textbox id="SellsName" runat="server" Width="100%" ></asp:textbox></td>
											...
											<tr bgColor="#f3f8fe">
												...
												<td><asp:textbox id="Starttime" runat="server" Width="100%" ></asp:textbox>
													<script>SetNeed('Starttime')</script>
												</td>
												<td align="right">结束时间：</td>
												<td>
													<asp:textbox id="Endtime" runat="server" Width="100%" ></asp:textbox>
