...
<%@ Page language="c#" Codebehind="OpenBank.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.OpenBank" %>
								...
								<td valign="top">
									<asp:datagrid id="Datagrid2" runat="server" AllowPaging="True" BorderWidth="1px" OnPageIndexChanged="MyDataGrid_Page_1"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="BankNumber" HeaderText="帐户号"></asp:BoundColumn>
										</Columns>
