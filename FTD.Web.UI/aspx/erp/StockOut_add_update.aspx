<%@ Page language="c#" Codebehind="StockOut_add_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOut_add_update" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;修改采购退货明细
								</td>
							</tr>
						</table>
					</td>
