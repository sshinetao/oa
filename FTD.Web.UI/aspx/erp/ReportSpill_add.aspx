<%@ Page language="c#" Codebehind="ReportSpill_add.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.ReportSpill_add" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%">
													<asp:textbox id="BsTimes" runat="server" Width="90%" ></asp:textbox>
