...
{
	/// <summary>
	/// Pdk_WorkStreamName_add_update 的摘要说明。
	/// </summary>
	public class Pdk_WorkStreamName_add_update : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				string    SQL_GetList     =  "select * from Pdk_WorkStreamName  where id='" + int.Parse(Request.QueryString["id"])+"'";
		...
		private void ImageButton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			string Sql_update ="Update Pdk_WorkStreamName Set Name_Jd='"+Name_Jd.Text+"',realname='"+realname.Text+"',username='"+username.Text+"' where id='" + int.Parse(Request.QueryString["id"])+"'";
