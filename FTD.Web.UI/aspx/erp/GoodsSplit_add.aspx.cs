...
{
	/// <summary>
	/// GoodsSplit_add 的摘要说明。
	/// </summary>
	public class GoodsSplit_add : System.Web.UI.Page
	{
		...
		private void ImageButton1_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
				...
				string Sql_update ="Update GoodsSplitLast  Set Storeroom='"+Storeroom.Text+"' where Keyfile='" +number.Text+"'";
			...
			string    SQL_GetList_rk     =  "select * from GoodsSplitLast where  Keyfile='"+number.Text+"' ";
			...
			/******************入库**************************/
				...
				this.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='GoodsSplit.aspx'</script>");
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string SQL_Del = "Delete from GoodsSplitLast where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void Datagrid2_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			try
			{
				...
				ImageButton4.Attributes.Add("onclick","window.showModalDialog('GoodsSplit_add_update.aspx?a='+Math.random()+'&id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"&number="+number.Text+"','window','dialogWidth:700px;DialogHeight=400px;status:no;help=no;scroll=no');window.location='#'");
