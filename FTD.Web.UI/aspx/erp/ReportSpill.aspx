<%@ Page language="c#" Codebehind="ReportSpill.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.ReportSpill" %>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="StockPeoName" SortExpression="StockPeoName" HeaderText="报溢人姓名">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
