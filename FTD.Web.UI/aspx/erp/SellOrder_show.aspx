...
<%@ Page language="c#" Codebehind="SellOrder_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellOrder_show" %>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox  id="Discount"  runat="server" Width="100%" >0</asp:textbox></td>
												<td align="right" width="15%"><FONT face="宋体">总金额(未打折)：</FONT></td>
												<td width="35%"><asp:textbox  id="AllMoney"  runat="server" Width="100%" >0</asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
												...
												<td width="100%" colSpan="4">
													<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
															...
															<Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="YfMoney" SortExpression="Model" HeaderText="超市进货价">
																	<HeaderStyle Wrap="False"></HeaderStyle>
																	<ItemStyle Wrap="False"></ItemStyle>
																</asp:BoundColumn>
