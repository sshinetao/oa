<%@ Page language="c#" Codebehind="GoodsMove_add_update.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.GoodsMove_add_update" %>
...
<HTML>
		...
		window.onerror = killErrors;	
            ...
            {  
                 ...
                 if(wNamekf!=null && wNamekf!= "undefined")
                 {
			    	...
			    	document.getElementById("CStoreroom").value=wNamekf; 
			    	return;
                 }
            ...
            {  
				 var num=Math.random();
                 wNamerk=window.showModalDialog("open_Storeroom.aspx?tmp="+num+"","window", "dialogWidth:500px;DialogHeight=500px;status:no;scroll=yes;help:no");               
             
                 if(wNamerk!=null && wNamerk!= "undefined")
                 {
                   
			    	document.getElementById("RStoreroom").value=wNamerk; 
			    	return;
                 }
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;新增调拨明细&nbsp;
								</td>
							</tr>
						</table>
					</td>
										...
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><FONT face="宋体">
														<asp:textbox id="CountUnit" runat="server"  Width="100%"></asp:textbox></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">规格型号：</FONT></td>
												<td width="35%"><FONT face="宋体">
														<asp:textbox id="Model" runat="server"  Width="100%"></asp:textbox></FONT></td>
												<td align="right" width="15%"><FONT face="宋体">颜色：</FONT></td>
												<td width="35%"><FONT face="宋体">
														<asp:textbox id="Color" runat="server"  Width="100%"></asp:textbox></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox onkeypress="var k=event.keyCode; return (k>=48&amp;&amp;k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData('text'))"
														id="SplitPoint" ondragenter="return false" style="IME-MODE: disabled" runat="server" Width="100%" onmouseout="selstr()">0</asp:textbox></td>
												<td align="right" width="15%"><FONT face="宋体">录入人：</FONT></td>
												<td width="35%"><FONT face="宋体">
														<asp:textbox id="Realname" runat="server"  Width="100%"></asp:textbox></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">调出仓：</FONT></td>
												<td width="35%"><FONT face="宋体">
														<asp:textbox id="CStoreroom" runat="server"  Width="90%"></asp:textbox></FONT><A href="javascript:void(0)"><IMG onclick="dc();" alt="" src="image/FDJ.gif" border="0"></A></td>
												<td align="right" width="15%"><FONT face="宋体">入库仓：</FONT></td>
												<td width="35%"><FONT face="宋体">
														<asp:textbox id="RStoreroom" runat="server"  Width="90%"></asp:textbox></FONT><A href="javascript:void(0)"><IMG onclick="rk();" alt="" src="image/FDJ.gif" border="0"></A></td>
											</tr>
							</tr>
						</table>
			...
			<asp:TextBox id="GoodsNumber" runat="server" style="DISPLAY: none"></asp:TextBox>
