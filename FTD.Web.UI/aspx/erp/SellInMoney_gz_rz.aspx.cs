...
{
	/// <summary>
	/// SellInMoney_gz_rz 的摘要说明。
	/// </summary>
	public class SellInMoney_gz_rz : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from SellInMoneylog_lc  where KeyField='"+Request.QueryString["number"]+"' order by id desc";
		...
		{
			Response.Redirect("SellInMoney_gz.aspx?id="+Request.QueryString["id"].ToString()+"");
		}
