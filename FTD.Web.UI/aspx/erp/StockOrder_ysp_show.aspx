<%@ Page language="c#" Codebehind="StockOrder_ysp_show.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockOrder_ysp_show" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="StockOrder_ysp.aspx">我审批的订单</A>&nbsp;&gt;&gt; 
									查看采购订单</td>
							</tr>
						</table>
					</td>
								...
								<td vAlign="top" bgColor="#f3f8fe">
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											...
											<tr bgColor="#f3f8fe">
												<td align="right"><FONT face="宋体">填写人：</FONT></td>
												<td colSpan="3"><asp:textbox id="realname" runat="server" Width="100%" ></asp:textbox><A href="javascript:void(0)"></A></FONT></td>
											</tr>
											<tr bgColor="#f3f8fe">
