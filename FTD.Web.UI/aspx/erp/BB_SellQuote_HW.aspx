<%@ Page language="c#" Codebehind="BB_SellQuote_HW.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_SellQuote_HW" %>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="title" SortExpression="title" HeaderText="对应报价单">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
											</Columns>
