...
<%@ Page language="c#" Codebehind="BB_SellInMoney_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.BB_SellInMoney_BT" %>
							...
							<tr>
								<td vAlign="top">
									...
									<FONT face="宋体" color="#ff0000"><STRONG>金额总计：<%=allmoney%>
											元&nbsp;&nbsp;&nbsp;已收金额：<%=yfmoney%>&nbsp;&nbsp;&nbsp;剩余金额：<%=symoney%></STRONG></FONT>
