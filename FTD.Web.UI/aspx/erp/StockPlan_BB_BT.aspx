...
<%@ Page language="c#" Codebehind="StockPlan_BB_BT.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.StockPlan_BB_BT" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TBODY>
					<TR>
						...
						<TD style="WIDTH: 93px"><asp:TextBox id="tilte" runat="server" Width="88px"></asp:TextBox></TD>
						<TD style="WIDTH: 39px"><FONT face="宋体">部门：</FONT></TD>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="StartTime" SortExpression="StartTime" HeaderText="计划开始时间">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="EndTime" SortExpression="EndTime" HeaderText="计划结束时间">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
