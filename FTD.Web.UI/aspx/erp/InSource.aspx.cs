...
namespace qpsmartweb_jxc
{
	...
	/// InSource 的摘要说明。
	/// </summary>
	public class InSource : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string SQL_GetList_xs    =  "select * from InSource order by IfSystem desc";
		...
		{
			Response.Redirect("InSource_add.aspx");
		}
		...
		private void ImageButton6_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				string SQL_Del = "Delete from InSource where id='"+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"'";
		...
		private void ImageButton5_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			try
			{
				...
				Response.Redirect("InSource_update.aspx?id="+Datagrid2.SelectedItem.Cells[1].Text.ToString()+"");
