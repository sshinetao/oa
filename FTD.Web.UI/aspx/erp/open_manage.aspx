<%@ Page language="c#" Codebehind="open_manage.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_manage" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg"><table width="92%" height="25" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="97%" class="headfont">员工检索</td>
							</tr>
						</table>
					</td>
									...
									<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#d8e1e8">
										<tr bgcolor="#f3f8fe">
											<td width="100%">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="25%"><FONT face="宋体">员工关键字：</FONT></td>
														<td width="42%">
													...
													<asp:datagrid id="Datagrid2" runat="server" Width="100%" AllowPaging="True" OnPageIndexChanged="MyDataGrid_Page_1"
														...
														<Columns>
															<asp:TemplateColumn>
																...
																<ItemTemplate>
																	&nbsp;<INPUT type="radio"  name="Rad" id="Radio1"  CHECKED value='<%#DataBinder.Eval(Container.DataItem, "name")%>|<%#DataBinder.Eval(Container.DataItem, "unit")%>|<%#DataBinder.Eval(Container.DataItem, "worknum")%>'>
																</ItemTemplate>
															</asp:TemplateColumn>
															<asp:BoundColumn DataField="name" HeaderText="人员姓名"></asp:BoundColumn>
														</Columns>
