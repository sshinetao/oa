...
<%@ Page language="c#" Codebehind="open_StockPlan.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_StockPlan" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td width="97%"><FONT color="#ffffff"> 导入采购计划</FONT></td>
							</tr>
						</table>
					</td>
