<%@ Page language="c#" Codebehind="open_StockOrder_Out.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.open_StockOrder_Out" %>
								...
								<td vAlign="top">
									<div class="mainDiv"><asp:datagrid id="Datagrid2" runat="server" Width="100%" BorderStyle="None" GridLines="Vertical"
											...
											<Columns>
												...
												<asp:BoundColumn Visible="False" DataField="number" SortExpression="number"></asp:BoundColumn>
											</Columns>
