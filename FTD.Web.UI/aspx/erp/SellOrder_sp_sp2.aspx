<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SellOrder_sp_sp2.aspx.cs" Inherits="FTD.Web.UI.aspx.erp.SellOrder_sp_sp2" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											...
											<td width="9%"><FONT face="宋体">
													<asp:ImageButton id="ImageButton1" runat="server" ImageUrl="i_blue/ok.jpg" OnClick="ImageButton1_Click1"></asp:ImageButton></FONT></td>
