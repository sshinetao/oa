<%@ Page language="c#" Codebehind="SellQuote.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellQuote" %>
									...
									<div class="mainDiv">
										<asp:datagrid id="Datagrid2" runat="server" BorderStyle="None" GridLines="Vertical" BackColor="White"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="title" SortExpression="tilte" HeaderText="计划标题">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="InvoiceType" HeaderText="发票类型">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
												...
												<asp:BoundColumn DataField="Ifopen" SortExpression="Ifopen" HeaderText="共享">
													<HeaderStyle Wrap="False"></HeaderStyle>
													<ItemStyle Wrap="False"></ItemStyle>
												</asp:BoundColumn>
