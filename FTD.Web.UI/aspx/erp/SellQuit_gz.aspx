<%@ Page language="c#" Codebehind="SellQuit_gz.aspx.cs" AutoEventWireup="false" Inherits="qpsmartweb_jxc.SellQuit_gz" %>
				...
				<tr>
					...
					<td width="748" background="i_blue/m_head_3.jpg">
						<table height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="main_1.aspx">工作台</A>&nbsp;&gt;&gt;&nbsp;<A class="line_b" href="SellQuit_gz.aspx">销售退货</A>&nbsp;&gt;&gt; 
									审批跟踪</td>
							</tr>
						</table>
					</td>
									...
									<table cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td align="right" width="15%"><FONT face="宋体"><FONT face="宋体"></FONT>客户名称：</FONT></td>
												<td width="35%">
													<asp:textbox id="CompanyName" runat="server" Width="100%" ></asp:textbox></td>
											</tr>
											<tr bgColor="#f3f8fe">
