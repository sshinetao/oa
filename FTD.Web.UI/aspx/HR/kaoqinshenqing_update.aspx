<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kaoqinshenqing_update.aspx.cs" Inherits="FTD.Web.UI.aspx.HR.kaoqinshenqing_update" %>
<!DOCTYPE html>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;考勤管理&nbsp;>>&nbsp;考勤申请修改
                </td>
            ...
            <tr>
                ...
                <td height="25" width="*" align="left">
                    <asp:DropDownList runat="server" ID="zhuangtai" Width="200px">
                        <asp:ListItem Value="撤销">撤销</asp:ListItem>
                        <asp:ListItem Value="请假中">请假中</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
