...
{
    public partial class kaoqinshenqing : System.Web.UI.Page
    {
        ...
        {
            FTD.BLL.KQSQ MyModel = new FTD.BLL.KQSQ();
        ...
        {
            Response.Redirect("kaoqinshenqing_add.aspx");
        }
        ...
        protected void iButton5_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("kaoqinshenqing_update.aspx?ID=" + CheckStrArray[0].ToString());
        }
