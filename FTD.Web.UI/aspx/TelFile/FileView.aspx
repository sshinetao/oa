<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileView.aspx.cs" Inherits="OA.aspx.TelFile.FileView" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="签收" OnClick="iButton2_Click" />
                    &nbsp;&nbsp; &nbsp;
