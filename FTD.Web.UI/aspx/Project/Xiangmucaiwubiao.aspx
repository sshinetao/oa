<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xiangmucaiwubiao.aspx.cs" Inherits="FTD.Web.UI.aspx.Project.Xiangmucaiwubiao" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">
                        ...
                        <asp:ListItem Value="Kemu">项目科目</asp:ListItem>
                        <asp:ListItem Value="Jine">金额</asp:ListItem>
                        <asp:ListItem Value="Riqi">记录日期</asp:ListItem>
                        <asp:ListItem Value="Zhuangtai">状态</asp:ListItem>
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="项目科目">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "XiangmucaiwubiaoView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "Kemu")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="Jine" HeaderText="金额"></asp:BoundField>
                            <asp:BoundField DataField="Riqi" HeaderText="记录日期"></asp:BoundField>
