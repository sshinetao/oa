...
{
    public partial class Xiangmucaiwubiao : System.Web.UI.Page
    {
        ...
        {
            BLL.XMCWB MyModel = new BLL.XMCWB();
        ...
        {
            Response.Redirect("XiangmucaiwubiaoAdd.aspx");
        }
        protected void iButton2_Click(object sender, EventArgs e)
        {
            string CheckStr = Unit.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
            string[] CheckStrArray = CheckStr.Split(',');
            Response.Redirect("Xiangmucaiwubiao.aspx?ID=" + CheckStrArray[0].ToString());
        }
        protected void iButton3_Click(object sender, EventArgs e)
        {
            string IDlist = Unit.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
            if (DBUnit.DbHelperSQL.ExecuteSQL("delete from Xiangmucaiwubiao where ID in (" + IDlist + ")") == -1)
            {
        ...
        protected void iButton5_Click(object sender, EventArgs e)
        {
            string CheckStr = Unit.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
            string[] CheckStrArray = CheckStr.Split(',');
            Response.Redirect("XiangmucaiwubiaoModify.aspx?ID=" + CheckStrArray[0].ToString());
        }
