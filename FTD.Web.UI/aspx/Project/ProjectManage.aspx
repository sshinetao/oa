<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectManage.aspx.cs" Inherits="OA.aspx.Project.ProjectManage" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style=" height: 30px;">
                    查询：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="80px"></asp:TextBox>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="YuJiChengJiaoRiQi" HeaderText="项目实施时间" >
                        </asp:BoundField> 
