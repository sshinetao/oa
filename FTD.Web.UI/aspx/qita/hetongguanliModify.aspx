<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hetongguanliModify.aspx.cs" Inherits="FTD.Web.UI.aspx.qita.hetongguanliModify" %>
...
ErrorMessage="必须是Office文档" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(
 
.doc|.dot|.docx|.dotx|.docm|.dotm|.xls|.xlt|.xla|.xlsx|.xltx|.xlsm|.xltm|.xlam|.xlsb|.ppt|.pot|.pps|.ppa|.pptx|.potx|.ppsx|.ppam|.pptm|.potm|.ppsm|.DOC|.DOT|.DOCX|.DOTX|.DOCM|.DOTM|.XLS|.XLT|.XLA|.XLSX|.XLTX|.XLSM|.XLTM|.XLAM|.XLSB|.PPT|.POT|.PPS|.PPA|.PPTX|.POTX|.PPSX|.PPAM|.PPTM|.POTM|.PPSM
)$"></asp:RegularExpressionValidator>
           </td>
              <td height="25" width="30%" align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">附件下载：</td>
           <td height="25" width="*" align="left">
