<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qitaziliaoguanliModify.aspx.cs" Inherits="FTD.Web.UI.aspx.qita.qitaziliaoguanliModify" %>
    ...
    <form id="form1" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#999999" class="gridview_m">
            ...
            <tr>
                ...
                <td height="25" width="*" align="left">
                    <asp:TextBox ID="neirongjianjie" runat="server" Width="100%" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
        </table>
    </form>
