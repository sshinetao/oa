<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hetongguanli.aspx.cs" Inherits="FTD.Web.UI.aspx.qita.hetongguanli" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;二手车管理&nbsp;>>&nbsp;我的二手车销售
                    </td>
                    <td align="right" valign="middle" style="height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">

                        <asp:ListItem Value="hetongfenlei">合同分类</asp:ListItem>
                        <asp:ListItem Value="bianhao">编号</asp:ListItem>
                        <asp:ListItem Value="jiafang">甲方</asp:ListItem>
                        <asp:ListItem Value="yifang">乙方</asp:ListItem>
                        <asp:ListItem Value="hetongjine">合同金额</asp:ListItem>
                        <asp:ListItem Value="hetongqixian">合同期限</asp:ListItem>
                        <asp:ListItem Value="qiandingriqi">签订日期</asp:ListItem>
                        <asp:ListItem Value="neirong">合同内容</asp:ListItem>



                    </asp:DropDownList><asp:TextBox ID="TextBox3" runat="server" Width="80px"></asp:TextBox>
                    ...
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="合同编号">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "hetongguanliView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "bianhao")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="hetongfenlei" HeaderText="合同分类"></asp:BoundField>
                            <asp:BoundField DataField="jiafang" HeaderText="甲方"></asp:BoundField>
                            <asp:BoundField DataField="yifang" HeaderText="乙方"></asp:BoundField>
                            <asp:BoundField DataField="hetongjine" HeaderText="合同金额"></asp:BoundField>
                            <asp:BoundField DataField="hetongqixian" HeaderText="合同期限"></asp:BoundField>
                            <asp:BoundField DataField="qiandingriqi" HeaderText="签订日期"></asp:BoundField>
                            <asp:TemplateField HeaderText="附件">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink2" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "fujian")%>'> 下载 </asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                        </Columns>
