<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rongyuguanli.aspx.cs" Inherits="FTD.Web.UI.aspx.qita.rongyuguanli" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">
                        <asp:ListItem Value="leibie">类别</asp:ListItem>
                        <asp:ListItem Value="banfabumen">颁发部门</asp:ListItem>
                        <asp:ListItem Value="banfashijian">颁发时间</asp:ListItem>
                         <asp:ListItem Value="youxiaoqi">有效期</asp:ListItem>
                    ...
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="名称">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "rongyuguanliView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "mingcheng")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>

                            <asp:BoundField DataField="leibie" HeaderText="类别"></asp:BoundField>
                            <asp:BoundField DataField="banfabumen" HeaderText="颁发部门"></asp:BoundField>
                            <asp:BoundField DataField="banfashijian" HeaderText="颁发时间"></asp:BoundField>
                            <asp:BoundField DataField="youxiaoqi" HeaderText="有效期"></asp:BoundField>
                        </Columns>
