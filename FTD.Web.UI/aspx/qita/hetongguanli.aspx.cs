...
{
    public partial class hetongguanli : System.Web.UI.Page
    {
        ...
        {
            FTD.BLL.HTGL MyModel = new FTD.BLL.HTGL();
        ...
        protected void iButton5_Click(object sender, EventArgs e)
        {
            string CheckStr = FTD.Unit.PublicMethod.CheckCbx(this.GVData, "CheckSelect", "LabVisible");
            string[] CheckStrArray = CheckStr.Split(',');
            Response.Redirect("hetongguanliModify.aspx?ID=" + CheckStrArray[0].ToString());
        }
