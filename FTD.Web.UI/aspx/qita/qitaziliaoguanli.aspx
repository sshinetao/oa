<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qitaziliaoguanli.aspx.cs" Inherits="FTD.Web.UI.aspx.qita.qitaziliaoguanli" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">
                         <asp:ListItem Value="mingcheng">名称</asp:ListItem>
                        <asp:ListItem Value="leibie">类别</asp:ListItem>
                        <asp:ListItem Value="neirongjianjie">内容简介</asp:ListItem>
                        <asp:ListItem Value="guidangshijian">归档时间</asp:ListItem>
                    ...
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="名称">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "qitaziliaoguanliView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "mingcheng")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>

                            <asp:BoundField DataField="leibie" HeaderText="类别"></asp:BoundField>
                            <asp:BoundField DataField="neirongjianjie" HeaderText="内容简介"></asp:BoundField>
                            <asp:BoundField DataField="guidangshijian" HeaderText="归档时间"></asp:BoundField>
