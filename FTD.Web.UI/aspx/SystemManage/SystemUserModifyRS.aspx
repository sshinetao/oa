<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemUserModifyRS.aspx.cs" Inherits="OA.aspx.SystemManage.SystemUserModifyRS" %>
<html>
	<head>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;人力资源&nbsp;>>&nbsp;维护人事档案
                </td>
...
<asp:Button ID="iButton1" runat="server" CssClass="btn btn-blue" Text="提交" OnClick="iButton1_Click" />
        ...
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">
                参加工作时间：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                <asp:TextBox id="TextBox23" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd hh:mm:ss',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">
                加入本单位时间：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                <asp:TextBox id="TextBox24" runat="server" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd hh:mm:ss',alwaysUseStartDate:true})" Width="350px" ></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">
                手机号码：</td>
        ...
        <tr>
            ...
            <td style="padding-left: 5px;   background-color: #ffffff">
                <asp:TextBox ID="ruzhishijian" runat="server"    Width="350px" DataType="DateTime" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})"></asp:TextBox></td>
        </tr>
             <tr>
            <td align="right" style="width: 170px;   background-color: #f9f9f7">
                合同签订时间：</td>
            <td style="padding-left: 5px;   background-color: #ffffff">
                <asp:TextBox ID="hetongqiandingshijian" runat="server"   Width="350px" DataType="DateTime" onClick="WdatePicker({startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})"></asp:TextBox></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">
                劳动合同签订情况：</td>
...
<asp:ImageButton ID="iButton2" runat="server" ImageAlign="AbsMiddle" ImageUrl="../../images/Button/UpLoad.jpg" OnClick="iButton2_Click" CausesValidation="False" /></td>
        ...
        <table id="Table1" style="width: 100%;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">              
        <tr>
            <td align="center" colspan="2" style="padding-left: 5px; height: 25px; background-color: #ffffff">
