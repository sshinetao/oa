...
namespace OA.aspx.SystemManage{ 
 public partial class SystemUserModifyRS: System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.ruzhishijian.Text =   MyBuMen.Ruzhishijian.ToString() ;
            this.hetongqiandingshijian.Text = MyBuMen.Hetongqiandingshijian.ToString();
    ...
    protected void iButton1_Click(object sender, EventArgs e)
    {
        ...
        {
            if (FTD.Unit.PublicMethod.IFExists("TrueName", "ERPUser", int.Parse(Request.QueryString["ID"].ToString()), this.TextBox3.Text) == true)
            {
                FTD.BLL.ERPUser MyBuMen = new FTD.BLL.ERPUser();
                ...
                MyBuMen.Ruzhishijian = Convert.ToDateTime(this.ruzhishijian.Text);
                MyBuMen.Hetongqiandingshijian = Convert.ToDateTime(this.hetongqiandingshijian.Text); //DateTime.Parse(this.hetongqiandingshijian.Text + "");
                MyBuMen.Update();
                //写系统日志
                ...
                MyRiZhi.Add();
                FTD.Unit.MessageBox.ShowAndRedirect(this, "人事档案信息修改成功！", "RenShiInfo.aspx");
            }
            else
            {
                FTD.Unit.MessageBox.Show(this, "该登录账号已经存在，请更换其他登录账号！");
            }
        }
        else
        {
