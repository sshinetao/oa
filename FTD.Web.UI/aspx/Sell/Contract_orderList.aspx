<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contract_orderList.aspx.cs" Inherits="FTD.Web.UI.aspx.Sell.Contract_orderList" %>
        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style=" height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;销售订单&nbsp;>>&nbsp;订单登记
                </td>
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hid_" Value="<%#DataBinder.Eval(Container.DataItem, "ID")%>" runat="server" />
                        ...
                        <asp:TemplateField HeaderText="合同名称">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "ContractView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "HeTongName")%></asp:HyperLink>
                            </ItemTemplate>
