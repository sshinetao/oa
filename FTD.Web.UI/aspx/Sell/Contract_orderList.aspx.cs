...
namespace FTD.Web.UI.aspx.Sell
{
    public partial class Contract_orderList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            FTD.Unit.PublicMethod.CheckSession();
            DataBindToGridview();
            iButton1.Visible = FTD.Unit.PublicMethod.StrIFIn("|pthy011A|", FTD.Unit.PublicMethod.GetSessionValue("QuanXian"));
            iButton5.Visible = FTD.Unit.PublicMethod.StrIFIn("|pthy011M|", FTD.Unit.PublicMethod.GetSessionValue("QuanXian"));
            iButton3.Visible = FTD.Unit.PublicMethod.StrIFIn("|pthy011D|", FTD.Unit.PublicMethod.GetSessionValue("QuanXian"));
            iButton2.Visible = FTD.Unit.PublicMethod.StrIFIn("|pthy011E|", FTD.Unit.PublicMethod.GetSessionValue("QuanXian"));
        }
        ...
        public void DataBindToGridview()
        {
            ...
            MyModel.HZ();
            string sql = " CreateUser='" + FTD.Unit.PublicMethod.GetSessionValue("UserName") + "'";
