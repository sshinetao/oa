<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nongchanpinpeisong_update.aspx.cs" Inherits="FTD.Web.UI.aspx.chanpinpeisong.nongchanpinpeisong_update" %>
<html >
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;产品配送管理&nbsp;>>&nbsp;更新配送信息
                </td>
