            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;产品配送管理&nbsp;>>&nbsp;农产品配送管理
                    </td>
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="peisongcheliang" HeaderText="配送车辆"></asp:BoundField>
                            <asp:BoundField DataField="peisonglicheng" HeaderText="配送里程"></asp:BoundField>
                            <asp:BoundField DataField="peisongren" HeaderText="配送人"></asp:BoundField>
                        </Columns>
