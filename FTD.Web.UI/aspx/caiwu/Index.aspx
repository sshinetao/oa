<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FTD.Web.UI.aspx.ashx.Index" %>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Label ID="LabVisible" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Months")%>'
					...
					<asp:TemplateField HeaderText="月份">
                         <ItemTemplate>
                              <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "liushui.aspx?m="+ DataBinder.Eval(Container.DataItem, "Months")+"&year="+year%>'>
                                  <%# DataBinder.Eval(Container.DataItem, "Months")%> 月</asp:HyperLink> 
