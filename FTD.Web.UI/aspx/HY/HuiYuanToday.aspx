<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuiYuanToday.aspx.cs" Inherits="FTD.Web.UI.aspx.HY.HuiYuanToday" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;会员管理&nbsp;>>&nbsp;我的会员&nbsp;>>&nbsp;今日还没发货
                </td>
...
<asp:Button ID="iButton1" runat="server" CssClass="btn btn-aqua" Text="发货" OnClick="iButton1_Click" />
<asp:Button ID="iButton5" runat="server" CssClass="btn btn-green" Text="导出" OnClick="iButton5_Click1" />
