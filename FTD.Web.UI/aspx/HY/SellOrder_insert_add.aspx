<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SellOrder_insert_add.aspx.cs" Inherits="FTD.Web.UI.aspx.HY.SellOrder_insert_add" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					...
					<td width="748" background="../erp/i_blue/m_head_3.jpg">
						<table id="Table2" height="25" cellSpacing="0" cellPadding="0" width="92%" border="0">
							<tr>
								<td class="headfont" width="97%"><A class="line_b" href="javascript:void(0)">工作台</A>&nbsp;&gt;&gt;&nbsp;新增销订单明细
								</td>
							</tr>
						</table>
					</td>
									...
									<table id="Table6" cellSpacing="1" cellPadding="4" width="100%" bgColor="#d8e1e8" border="0">
										<TBODY>
											<tr bgColor="#f3f8fe">
												...
												<td width="35%"><asp:textbox id="GoodsNumber" runat="server" Width="90%" ></asp:textbox><A href="javascript:void(0)"><IMG onclick="cpOpen();" alt="" src="../erp/image/FDJ.gif" border="0"></A></td>
												<td align="right" width="15%"><FONT face="宋体">货品名称：</FONT></td>
												<td width="35%"><asp:textbox id="GoodsName" runat="server" Width="90%" ></asp:textbox><A href="javascript:void(0)"><IMG onclick="cpOpen();" alt="" src="../erp/image/FDJ.gif" border="0"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
											...
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">销售数量：</FONT></td>
												...
												<td align="right" width="15%"><FONT face="宋体">单价：</FONT></td>
												<td width="35%"><asp:textbox onkeypress="var k=event.keyCode; return (k>=48&amp;&amp;k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData('text'))"
														id="SingleMoney" ondragenter="return false" style="IME-MODE: disabled" runat="server" Width="100%" onmouseout="selstr()">0</asp:textbox><A href="javascript:void(0)"></A></td>
											</tr>
											<tr bgColor="#f3f8fe">
												<td align="right" width="15%"><FONT face="宋体">销售总金额：</FONT></td>
												<td width="35%"><asp:textbox onkeypress="var k=event.keyCode; return (k>=48&amp;&amp;k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData('text'))"
							...
							<TR>
								<td background="i_blue/third_head_bg1.jpg">
									<table id="Table8" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td width="39%">&nbsp;</td>
											<td width="9%"><asp:imagebutton id="ImageButton1" runat="server" ImageUrl="../erp/i_blue/ok.jpg" onmouseover="selstr()" OnClick="ImageButton1_Click1"></asp:imagebutton></td>
											<td width="52%"><a href="JavaScript:void(0)"><img src="../erp/i_blue/close.jpg" border="0" onclick="CCC()"></a></td>
										</tr>
									</table>
								</td>
							</TR>
			...
			<script language="javascript">
			    ...
			    function cpOpen() {
			        var num = Math.random();
			        wName_1 = window.showModalDialog("../erp/open_GoodsData.aspx?tmp=" + num + " ", "window", "dialogWidth:800px;DialogHeight=500px;status:no;scroll=yes;help:no");
