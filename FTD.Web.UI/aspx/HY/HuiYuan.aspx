<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuiYuan.aspx.cs" Inherits="OA.aspx.HY.HuiYuan" %>
<html>
	<head>
...
<asp:Button ID="Button1" runat="server" CssClass="btn btn-purple" Text="冻结" OnClick="iButton8_Click" OnClientClick="javascript:return Checkdongjie();"/>
<asp:Button ID="Button2" runat="server" CssClass="btn btn-red" Text="解冻" OnClick="iButton7_Click" OnClientClick="javascript:return Checkdongjie();"/>
...
<asp:Button ID="iButton3" runat="server" OnClientClick="javascript:return CheckDel();" CssClass="btn btn-red" Text="删除" OnClick="iButton3_Click" />   
                    &nbsp;
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导入" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
            </tr>
        </table>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="weekday" HeaderText="配送规则" ></asp:BoundField>     
					   
					<asp:BoundField DataField="statName" HeaderText="状态" ></asp:BoundField>      
</Columns>
