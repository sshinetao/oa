<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpjgtj.aspx.cs" Inherits="FTD.Web.UI.aspx.baozhuang.cpjgtj1" %>
<!DOCTYPE html>
                    ...
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="品名">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "Cpjgtj_update.aspx?ID="+ DataBinder.Eval(Container.DataItem, "id")%>'><%# DataBinder.Eval(Container.DataItem, "pname")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="shuliang" HeaderText="数量"></asp:BoundField>
                            <asp:BoundField DataField="zhiliang" HeaderText="质量"></asp:BoundField>
                        </Columns>
