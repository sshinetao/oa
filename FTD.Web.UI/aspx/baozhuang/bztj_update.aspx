<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bztj_update.aspx.cs" Inherits="FTD.Web.UI.aspx.baozhuang.bztj_update" %>
<!DOCTYPE html>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right" valign="middle" style="height: 30px;">
                    ...
                    &nbsp;
                    <asp:HiddenField ID="hidVal3" runat="server" />
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#999999" class="gridview_m">
            <tr>
                ...
                <td height="25" width="*" align="left">
                     ...
                     <asp:TextBox ID="pname3" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td height="25" width="*" align="left">
                     ...
                     <asp:TextBox ID="shuliang3" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td height="25" width="30%" align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">质量：</td>
                <td height="25" width="*" align="left">
                    <asp:TextBox ID="zhiliang3" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
