<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bztj_add.aspx.cs" Inherits="FTD.Web.UI.aspx.baozhuang.bztj_add" %>
<!DOCTYPE html>
        ...
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right" valign="middle" style="height: 30px;">
                    <asp:Button ID="iButton2" runat="server" CssClass="btn btn-blue" Text="提交" OnClick="iButton1_Click" />
                    &nbsp;
