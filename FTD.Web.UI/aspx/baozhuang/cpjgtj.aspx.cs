...
{
    public partial class cpjgtj1 : System.Web.UI.Page
    {
        ...
        {
            FTD.BLL.Cpjgtj MyModel = new FTD.BLL.Cpjgtj();

            GVData.DataSource = MyModel.GetList("1=1 order by ID desc");
            GVData.DataBind();
        ...
        {
            Response.Redirect("cpjgtj_add.aspx");
        }
        ...
        protected void iButton5_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("cpjgtj_update.aspx?ID=" + CheckStrArray[0].ToString());
        }
