<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bztj.aspx.cs" Inherits="FTD.Web.UI.aspx.baozhuang.bztj" %>
<!DOCTYPE html>
                    ...
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="品名">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "bztj_update.aspx?ID="+ DataBinder.Eval(Container.DataItem, "id")%>'><%# DataBinder.Eval(Container.DataItem, "pname")%></asp:HyperLink>
                                </ItemTemplate>
