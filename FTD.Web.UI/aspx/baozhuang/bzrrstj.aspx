<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bzrrstj.aspx.cs" Inherits="FTD.Web.UI.aspx.baozhuang.bzrrystj" %>
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="pname" HeaderText="产品名称"></asp:BoundField>
                            <asp:BoundField DataField="yongshi" HeaderText="用时"></asp:BoundField>
                            <asp:BoundField DataField="shuliang" HeaderText="数量"></asp:BoundField>
                            <asp:BoundField DataField="gongzi" HeaderText="应付工资"></asp:BoundField>
