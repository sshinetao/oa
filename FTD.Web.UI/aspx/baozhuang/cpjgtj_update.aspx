<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cpjgtj_update.aspx.cs" Inherits="FTD.Web.UI.aspx.baozhuang.cpjgtj_update" %>
 <!DOCTYPE html>
...
<body>
    <form id="form5" runat="server">
        <table id="PrintHide5" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;加工包装管理&nbsp;>>&nbsp;包装人员用时统计
                </td>
                <td align="right" valign="middle" style="height: 30px;">
                    <asp:Button ID="iButton5" runat="server" CssClass="btn btn-blue" Text="提交" OnClick="iButton1_Click" />
                    &nbsp;
                    <asp:HiddenField ID="hidVal5" runat="server" />
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor="#999999" class="gridview_m">
            <tr>
                ...
                <td height="25" width="*" align="left">
                     ...
                     <asp:TextBox ID="pname5" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td height="25" width="*" align="left">
                     ...
                     <asp:TextBox ID="shuliang5" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td height="25" width="30%" align="right" style="width: 170px; height: 25px; background-color: #f9f9f7">质量：</td>
                <td height="25" width="*" align="left">
                    <asp:TextBox ID="zhiliang5" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>
