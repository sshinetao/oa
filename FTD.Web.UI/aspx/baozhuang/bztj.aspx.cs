...
{
    public partial class bztj : System.Web.UI.Page
    {
        ...
        {
            FTD.BLL.Bztj MyModel = new FTD.BLL.Bztj();
        ...
        {
            Response.Redirect("bztj_add.aspx");
        }
        ...
        protected void iButton5_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("bztj_update.aspx?ID=" + CheckStrArray[0].ToString());
        }
