<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarBaoYang.aspx.cs" Inherits="OA.aspx.Car.CarBaoYang" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;驾驶员违章违规管理
                </td>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarBaoYangView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="BYDate" HeaderText="违章日期" ></asp:BoundField>     
					<asp:BoundField DataField="JingBanUser" HeaderText="车牌号" ></asp:BoundField>     
					<asp:BoundField DataField="ZhuGuanUser" HeaderText="违规事由" ></asp:BoundField>        
					<asp:BoundField DataField="QiYouJinE" HeaderText="处罚结果" ></asp:BoundField>       
					<asp:BoundField DataField="OtherJinE" HeaderText="自动考核" ></asp:BoundField>  
</Columns>
