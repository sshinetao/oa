<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarWeiHu.aspx.cs" Inherits="OA.aspx.Car.CarWeiHu" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;车辆管理&nbsp;>>&nbsp;车辆维修管理
                </td>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarWeiHuView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="WeiHuRiQi" HeaderText="维修时间" ></asp:BoundField>     
					<asp:BoundField DataField="WeiHuLeiXing" HeaderText="车牌号" ></asp:BoundField>   
					<asp:BoundField DataField="JingBanUser" HeaderText="维修情况" ></asp:BoundField>     
					<asp:BoundField DataField="WeiHuFeiYong" HeaderText="维修结果" ></asp:BoundField>     
