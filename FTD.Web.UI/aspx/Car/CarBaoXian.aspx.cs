...
namespace OA.aspx.Car{ 
 public partial class CarBaoXian: System.Web.UI.Page
{
	...
	{
		FTD.BLL.ERPCarBaoXian MyModel = new FTD.BLL.ERPCarBaoXian();
	...
	protected void iButton3_Click(object sender, EventArgs e)
	{
		...
		if (FTD.DBUnit.DbHelperSQL.ExecuteSQL("delete from ERPCarBaoXian where ID in (" + IDlist + ")") == -1)
		{
		...
		else
		{
			...
			MyRiZhi.DoSomething = "用户删除车辆保险/年检信息";
	...
	protected void iButton2_Click(object sender, EventArgs e)
	{
		...
		MyTable.Add("FeiYongName", "车牌号");
		//MyTable.Add("ProjectName", "保险/年检时间");
		MyTable.Add("BaoXianPrice", "保险/年检费用");
		MyTable.Add("BaoXianDate", "保险/年检有效期");
		MyTable.Add("TiXingDate", "提醒日期");
		MyTable.Add("TimeStr", "保险/年检时间");
		MyTable.Add("BackInfo", "备注说明");
		FTD.Unit.DataToExcel.GridViewToExcel(FTD.DBUnit.DbHelperSQL.GetDataSet("select  CarName,FeiYongName,BaoXianPrice,BaoXianDate,TiXingDate,TimeStr,BackInfo  from ERPCarBaoXian where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}
