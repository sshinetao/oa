<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarNianJian.aspx.cs" Inherits="OA.aspx.Car.CarNianJian" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarNianJianView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="Username" HeaderText="培训内容" ></asp:BoundField>     
					<asp:BoundField DataField="Chejiandate" HeaderText="培训方式" ></asp:BoundField>     
					<asp:BoundField DataField="Timestr" HeaderText="培训时间" ></asp:BoundField>     
</Columns>
