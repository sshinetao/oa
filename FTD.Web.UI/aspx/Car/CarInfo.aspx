<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarInfo.aspx.cs" Inherits="OA.aspx.Car.CarInfo" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarInfoView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="CarPaiHao" HeaderText="车牌号" ></asp:BoundField>   
					<asp:BoundField DataField="Dunwei" HeaderText="车辆吨位" ></asp:BoundField>     
					<asp:BoundField DataField="LeiXing" HeaderText="购车时间" ></asp:BoundField>     
					<asp:BoundField DataField="Fapiao" HeaderText="发票号码" ></asp:BoundField>     
					<asp:BoundField DataField="Gps" HeaderText="GPS安装情况" ></asp:BoundField>   
</Columns>
