<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarBaoXian.aspx.cs" Inherits="OA.aspx.Car.CarBaoXian" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名字"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarBaoXianView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="FeiYongName" HeaderText="车牌号" ></asp:BoundField>     
					<asp:BoundField DataField="ProjectName" HeaderText="保险/年检时间" ></asp:BoundField>     
					<asp:BoundField DataField="BaoXianPrice" HeaderText="保险/年检费用" ></asp:BoundField>     
					<asp:BoundField DataField="BaoXianDate" HeaderText="保险/年检有效期" ></asp:BoundField>     
