<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarWeiZhang.aspx.cs" Inherits="OA.aspx.Car.CarWeiZhang" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarWeiZhangView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="WZDate" HeaderText="登记时间" ></asp:BoundField>     
					<asp:BoundField DataField="DriverUser" HeaderText="车牌号" ></asp:BoundField>      
					<asp:BoundField DataField="KouFenNum" HeaderText="事故情况" ></asp:BoundField>     
					<asp:BoundField DataField="FKJinE" HeaderText="处理结果" ></asp:BoundField>    
</Columns>
