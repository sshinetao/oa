<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarLog.aspx.cs" Inherits="OA.aspx.Car.CarLog" %>
<html>
	<head>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarLogView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="LogDate" HeaderText="驾驶证有效期" ></asp:BoundField>     
					<asp:BoundField DataField="JingBanUser" HeaderText="姓名" ></asp:BoundField>     
					<asp:BoundField DataField="DriverUser" HeaderText="电话" ></asp:BoundField>     
					<asp:BoundField DataField="ChuCheDate" HeaderText="从业证有效期" ></asp:BoundField>   
					<asp:BoundField DataField="XingShiTime" HeaderText="驾驶证号" ></asp:BoundField>  
					<asp:BoundField DataField="XingShiLiCheng" HeaderText="从业证号" ></asp:BoundField>     
					<asp:BoundField DataField="YouHaoShu" HeaderText="身份证号" ></asp:BoundField>     
</Columns>
