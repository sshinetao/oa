<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarShiYong.aspx.cs" Inherits="OA.aspx.Car.CarShiYong" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;车辆管理&nbsp;>>&nbsp;车辆使用管理
                </td>
                <td align="right" valign="middle" style=" height: 30px;">
                    查询：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="60px"></asp:TextBox>
...
<asp:Button ID="iButton2" runat="server" CssClass="btn btn-aqua" Text="导出" OnClick="iButton2_Click" />&nbsp;<button type="button" class="btn btn-yellow" onclick="javascript:window.history.go(-1)">返回</button></td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" CssClass="gridview_m"  runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="车辆名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "CarShiYongView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CarName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="YongCheUser" HeaderText="使用人" ></asp:BoundField>     
					<asp:BoundField DataField="ShengQingShiYou" HeaderText="用车事由" ></asp:BoundField>     
					<asp:BoundField DataField="QiShiTime" HeaderText="登记用车时间" ></asp:BoundField>     
					<asp:BoundField DataField="JieShuTime" HeaderText="还车时间" ></asp:BoundField>     
