<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="FTD.Web.UI.aspx.oldcar.List" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="height: 30px;">查询：<asp:DropDownList ID="DropDownList2" runat="server">
                        <asp:ListItem Value="plat_num">车牌号</asp:ListItem>
                        <asp:ListItem Value="chejianum">车架号</asp:ListItem>
                        <asp:ListItem Value="cartype">车辆类型</asp:ListItem>
                    ...
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="车牌号">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="False" ForeColor="green" NavigateUrl='<%# "OldCarView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "plat_num")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>

                            <asp:BoundField DataField="chejianum" HeaderText="车架号"></asp:BoundField>
                            <asp:BoundField DataField="buyer" HeaderText="买方"></asp:BoundField>
                            <asp:BoundField DataField="buy_tel" HeaderText="买方电话"></asp:BoundField>
                            <asp:BoundField DataField="seller" HeaderText="卖方"></asp:BoundField>
                            <asp:BoundField DataField="sell_tel" HeaderText="卖方电话"></asp:BoundField>
                            <asp:BoundField DataField="cartype" HeaderText="车辆类型"></asp:BoundField>
                        </Columns>
