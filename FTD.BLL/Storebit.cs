...
namespace FTD.BLL
{
	...
	public partial class Storebit
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public Storebit(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,Number,Name,Storeroom ");
			strSql.Append(" FROM [Storebit] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Storebit]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [Storebit] (");
			strSql.Append("Number,Name,Storeroom)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [Storebit] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Storebit] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
