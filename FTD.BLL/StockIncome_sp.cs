...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class StockIncome_sp
	{
		public StockIncome_sp()
		{}
		#region Model
		private long _id;
		...
		public StockIncome_sp(long Id)
		{
			...
			strSql.Append(" FROM [StockIncome_sp] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockIncome_sp]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockIncome_sp] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockIncome_sp] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockIncome_sp] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
