...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellOrderlog_lc
	{
		public SellOrderlog_lc()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public SellOrderlog_lc(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,settime,KeyField ");
			strSql.Append(" FROM [SellOrderlog_lc] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellOrderlog_lc]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellOrderlog_lc] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellOrderlog_lc] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellOrderlog_lc] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
