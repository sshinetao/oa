...
namespace FTD.BLL
{
	...
	public class ERPUser
	{
        ...
        private DateTime? _ruzhishijian;

        public DateTime? Ruzhishijian
        {
            get { return _ruzhishijian; }
            set { _ruzhishijian = value; }
        }


        private DateTime? _hetongqiandingshijian;

        public DateTime? Hetongqiandingshijian
        {
            get { return _hetongqiandingshijian; }
            set { _hetongqiandingshijian = value; }
        }
		...
		public int Add()
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@FuJian", SqlDbType.VarChar,5000)  ,
                     new SqlParameter("@ruzhishijian", SqlDbType.DateTime)           ,
              new SqlParameter("@hetongqiandingshijian", SqlDbType.DateTime)   
                                        };
            ...
            parameters[40].Value = Ruzhishijian;
            parameters[41].Value = Hetongqiandingshijian;
		...
		public void Update()
		{
            ...
            strSql.Append("ruzhishijian=@ruzhishijian,");
            strSql.Append("hetongqiandingshijian=@hetongqiandingshijian");
			strSql.Append(" where ID="+ID+" ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
					new SqlParameter("@UserName", SqlDbType.VarChar,50),
			...
			parameters[39].Value = BeiZhuStr;
			parameters[40].Value = FuJian;
            parameters[41].Value = Ruzhishijian;
            parameters[42].Value = Hetongqiandingshijian;
		...
		public void GetModel(int ID)
		{
			...
			if(ds.Tables[0].Rows.Count>0)
			{
                ...
                if (ds.Tables[0].Rows[0]["ruzhishijian"].ToString() != "")
                {
                    Ruzhishijian = DateTime.Parse(ds.Tables[0].Rows[0]["ruzhishijian"] + "");
                }
                if (ds.Tables[0].Rows[0]["hetongqiandingshijian"].ToString() != "")
                {
                    Hetongqiandingshijian = DateTime.Parse(ds.Tables[0].Rows[0]["hetongqiandingshijian"] + "");
                }
