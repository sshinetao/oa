...
{
	/// <summary>
	/// 类Cgrk_WorkStreamName。
	/// </summary>
	[Serializable]
	public partial class Cgrk_WorkStreamName
	{
		public Cgrk_WorkStreamName()
		{}
		#region Model
		private long _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Cgrk_WorkStreamName]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [Cgrk_WorkStreamName] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [Cgrk_WorkStreamName] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Cgrk_WorkStreamName] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
