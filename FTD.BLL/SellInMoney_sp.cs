...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellInMoney_sp
	{
		public SellInMoney_sp()
		{}
		#region Model
		private long _id;
		...
		public SellInMoney_sp(long Id)
		{
			...
			strSql.Append(" FROM [SellInMoney_sp] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellInMoney_sp]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellInMoney_sp] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellInMoney_sp] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellInMoney_sp] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
