...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class OutRoomMx
	{
		public OutRoomMx()
		{}
		#region Model
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [OutRoomMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [OutRoomMx] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [OutRoomMx] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [OutRoomMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
        ...
        public void GetModel(string Keyfile)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,Keyfile,GoodsNumber,GoodsName,CountUnit,Model,StockPoint,Username,Realname,Nowtimes ");
            strSql.Append(" FROM [OutRoomMx] ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Keyfile", SqlDbType.VarChar)};
            parameters[0].Value = Keyfile;
