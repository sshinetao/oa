...
{
	/// <summary>
	/// 类Xsdd_WorkStreamName。
	/// </summary>
	[Serializable]
	public partial class Xsdd_WorkStreamName
	{
		public Xsdd_WorkStreamName()
		{}
		#region Model
		private long _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Xsdd_WorkStreamName]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [Xsdd_WorkStreamName] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [Xsdd_WorkStreamName] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Xsdd_WorkStreamName] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
        ...
        public void GetModel(string strsql)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,Name_type,Name_Jd,username,realname,KeyFile,BigId ");
            strSql.Append(" FROM [Xsdd_WorkStreamName] ");
