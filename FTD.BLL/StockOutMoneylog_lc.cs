...
{
	/// <summary>
	/// 类StockOutMoneylog_lc。
	/// </summary>
	[Serializable]
	public partial class StockOutMoneylog_lc
	{
		public StockOutMoneylog_lc()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public StockOutMoneylog_lc(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,settime,KeyField ");
			strSql.Append(" FROM [StockOutMoneylog_lc] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockOutMoneylog_lc]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockOutMoneylog_lc] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockOutMoneylog_lc] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockOutMoneylog_lc] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
