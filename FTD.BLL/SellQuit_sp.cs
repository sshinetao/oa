...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellQuit_sp
	{
		public SellQuit_sp()
		{}
		#region Model
		...
		/// 得到一个对象实体
		/// </summary>
		public SellQuit_sp(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,number,title,ShTime,Storeroom,CompanyNumber,CompanyName,CompanyAdd,StockPeoNum,StockPeoName,Remark,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,Spusername,Sprealname,MyTimes ");
			strSql.Append(" FROM [SellQuit_sp] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellQuit_sp]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellQuit_sp] (");
			strSql.Append("number,title,ShTime,Storeroom,CompanyNumber,CompanyName,CompanyAdd,StockPeoNum,StockPeoName,Remark,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,Spusername,Sprealname,MyTimes)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellQuit_sp] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellQuit_sp] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
