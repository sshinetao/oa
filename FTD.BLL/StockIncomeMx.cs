...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class StockIncomeMx
	{
		public StockIncomeMx()
		{}
		#region Model
		private long _id;
		...
		public StockIncomeMx(long Id)
		{
			...
			strSql.Append(" FROM [StockIncomeMx] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockIncomeMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockIncomeMx] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockIncomeMx] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockIncomeMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
