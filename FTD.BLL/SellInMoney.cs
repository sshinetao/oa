...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellInMoney
	{
		public SellInMoney()
		{}
		#region Model
		...
		public SellInMoney(long Id)
		{
			...
			strSql.Append(" FROM [SellInMoney] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellInMoney]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellInMoney] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellInMoney] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellInMoney] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
