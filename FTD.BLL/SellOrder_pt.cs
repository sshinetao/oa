...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellOrder_pt
	{
		public SellOrder_pt()
		{}
		#region Model
		...
		public SellOrder_pt(long Id)
		{
			...
			strSql.Append(" FROM [SellOrder_pt] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellOrder_pt]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellOrder_pt] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellOrder_pt] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellOrder_pt] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
