...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class StockMoney
	{
		public StockMoney()
		{}
		#region Model
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockMoney]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockMoney] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockMoney] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockMoney] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
