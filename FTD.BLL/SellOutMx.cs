...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellOutMx
	{
		public SellOutMx()
		{}
		#region Model
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellOutMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellOutMx] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellOutMx] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellOutMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
