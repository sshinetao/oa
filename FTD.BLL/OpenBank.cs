...
namespace FTD.BLL
{
	...
	public partial class OpenBank
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public OpenBank(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,Name,BankNumber ");
			strSql.Append(" FROM [OpenBank] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [OpenBank]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [OpenBank] (");
			strSql.Append("Name,BankNumber)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [OpenBank] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [OpenBank] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
