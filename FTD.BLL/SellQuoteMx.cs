...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellQuoteMx
	{
		public SellQuoteMx()
		{}
		#region Model
		...
		/// 得到一个对象实体
		/// </summary>
		public SellQuoteMx(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Keyfile,GoodsNumber,GoodsName,CountUnit,Model,StockPoint,SingleMoney,Allmoney,Username,Realname,Nowtimes,Type ");
			strSql.Append(" FROM [SellQuoteMx] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellQuoteMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellQuoteMx] (");
			strSql.Append("Keyfile,GoodsNumber,GoodsName,CountUnit,Model,StockPoint,SingleMoney,Allmoney,Username,Realname,Nowtimes,Type)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellQuoteMx] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellQuoteMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
