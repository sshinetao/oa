...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class StockOrderlog_lc
	{
		public StockOrderlog_lc()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public StockOrderlog_lc(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,settime,KeyField ");
			strSql.Append(" FROM [StockOrderlog_lc] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockOrderlog_lc]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockOrderlog_lc] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockOrderlog_lc] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockOrderlog_lc] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
