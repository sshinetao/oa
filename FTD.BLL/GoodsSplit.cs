...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class GoodsSplit
	{
		public GoodsSplit()
		{}
		#region Model
		...
		/// 得到一个对象实体
		/// </summary>
		public GoodsSplit(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,number,GoodsNumber,GoodsName,CountUnit,Model,Color,Storeroom,SplitPoint,Username,Realname,Nowtimes,Remark,MyTimes ");
			strSql.Append(" FROM [GoodsSplit] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [GoodsSplit]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [GoodsSplit] (");
			strSql.Append("number,GoodsNumber,GoodsName,CountUnit,Model,Color,Storeroom,SplitPoint,Username,Realname,Nowtimes,Remark,MyTimes)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [GoodsSplit] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [GoodsSplit] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
