...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class Rk_WorkStreamName
	{
		public Rk_WorkStreamName()
		{}
		#region Model
		private long _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Rk_WorkStreamName]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [Rk_WorkStreamName] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [Rk_WorkStreamName] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Rk_WorkStreamName] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
