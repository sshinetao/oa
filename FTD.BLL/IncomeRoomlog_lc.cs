...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class IncomeRoomlog_lc
	{
		public IncomeRoomlog_lc()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public IncomeRoomlog_lc(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,settime,KeyField ");
			strSql.Append(" FROM [IncomeRoomlog_lc] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [IncomeRoomlog_lc]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [IncomeRoomlog_lc] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [IncomeRoomlog_lc] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [IncomeRoomlog_lc] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
