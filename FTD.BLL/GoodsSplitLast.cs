...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class GoodsSplitLast
	{
		public GoodsSplitLast()
		{}
		#region Model
		private long _id;
		...
		public GoodsSplitLast(long Id)
		{
			...
			strSql.Append(" FROM [GoodsSplitLast] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [GoodsSplitLast]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [GoodsSplitLast] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [GoodsSplitLast] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [GoodsSplitLast] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
