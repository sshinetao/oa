...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class GoodsMoveMx
	{
		public GoodsMoveMx()
		{}
		#region Model
		...
		private string _cstoreroom;
		private string _rstoreroom;
		...
		/// 
		/// </summary>
		public string CStoreroom
		{
			set{ _cstoreroom=value;}
			get{return _cstoreroom;}
		}
		/// <summary>
		/// 
		/// </summary>
		public string RStoreroom
		{
			set{ _rstoreroom=value;}
			get{return _rstoreroom;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		public GoodsMoveMx(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Keyfile,GoodsNumber,GoodsName,CountUnit,Model,Color,SplitPoint,CStoreroom,RStoreroom,Username,Realname,Nowtimes ");
			strSql.Append(" FROM [GoodsMoveMx] ");
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["CStoreroom"]!=null)
				{
					this.CStoreroom=ds.Tables[0].Rows[0]["CStoreroom"].ToString();
				}
				if(ds.Tables[0].Rows[0]["RStoreroom"]!=null)
				{
					this.RStoreroom=ds.Tables[0].Rows[0]["RStoreroom"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [GoodsMoveMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [GoodsMoveMx] (");
			strSql.Append("Keyfile,GoodsNumber,GoodsName,CountUnit,Model,Color,SplitPoint,CStoreroom,RStoreroom,Username,Realname,Nowtimes)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@CStoreroom", SqlDbType.NVarChar,50),
					new SqlParameter("@RStoreroom", SqlDbType.NVarChar,50),
			...
			parameters[6].Value = SplitPoint;
			parameters[7].Value = CStoreroom;
			parameters[8].Value = RStoreroom;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [GoodsMoveMx] set ");
			...
			strSql.Append("CStoreroom=@CStoreroom,");
			strSql.Append("RStoreroom=@RStoreroom,");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [GoodsMoveMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
