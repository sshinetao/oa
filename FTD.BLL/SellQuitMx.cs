...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class SellQuitMx
	{
		public SellQuitMx()
		{}
		#region Model
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [SellQuitMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [SellQuitMx] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [SellQuitMx] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [SellQuitMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
