...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class ReportLoseMx
	{
		public ReportLoseMx()
		{}
		#region Model
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [ReportLoseMx]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [ReportLoseMx] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [ReportLoseMx] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [ReportLoseMx] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
