...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class StockIncomelog_lc
	{
		public StockIncomelog_lc()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public StockIncomelog_lc(long id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,settime,KeyField ");
			strSql.Append(" FROM [StockIncomelog_lc] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockIncomelog_lc]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockIncomelog_lc] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockIncomelog_lc] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockIncomelog_lc] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
