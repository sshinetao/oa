...
{
	/// <summary>
	/// 类Cgfk_WorkStreamName。
	/// </summary>
	[Serializable]
	public partial class Cgfk_WorkStreamName
	{
		public Cgfk_WorkStreamName()
		{}
		#region Model
		private long _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Cgfk_WorkStreamName]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [Cgfk_WorkStreamName] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [Cgfk_WorkStreamName] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Cgfk_WorkStreamName] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
