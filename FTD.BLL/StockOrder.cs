	...
	public partial class StockOrder
	{
		...
		public StockOrder(long Id)
		{
			...
			if(ds.Tables[0].Rows.Count>0)
			{
                ...
                if (ds.Tables[0].Rows[0]["dingdanleixing"] != null)
                {
                    this.Ifopen = ds.Tables[0].Rows[0]["dingdanleixing"].ToString();
                }
			}
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockOrder]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockOrder] set ");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@MyTimes", SqlDbType.DateTime),
					new SqlParameter("@Ifopen", SqlDbType.NVarChar,50),
                    new SqlParameter("@dingdanleixing", SqlDbType.NVarChar,50),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockOrder] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
