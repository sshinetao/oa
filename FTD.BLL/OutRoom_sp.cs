...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class OutRoom_sp
	{
		public OutRoom_sp()
		{}
		#region Model
		...
		/// 得到一个对象实体
		/// </summary>
		public OutRoom_sp(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,number,title,Storeroom,ThPeople,Tel,ThTime,OutUse,Remark,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,Spusername,Sprealname,MyTimes ");
			strSql.Append(" FROM [OutRoom_sp] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [OutRoom_sp]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [OutRoom_sp] (");
			strSql.Append("number,title,Storeroom,ThPeople,Tel,ThTime,OutUse,Remark,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,Spusername,Sprealname,MyTimes)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [OutRoom_sp] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [OutRoom_sp] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
