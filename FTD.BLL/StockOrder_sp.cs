...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class StockOrder_sp
	{
		public StockOrder_sp()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public StockOrder_sp(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,number,title,Type,NbNumber,QdTime,OrderRemark,OrderAdd,LxAdd,Storeroom,ShTime,CompanyNumber,CompanyName,CompanyAdd,Unit,StockPeoNum,StockPeoName,AllMoney,YfMoney,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,MyTimes,Ifopen,Spusername,Sprealname ");
			strSql.Append(" FROM [StockOrder_sp] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [StockOrder_sp]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [StockOrder_sp] (");
			strSql.Append("number,title,Type,NbNumber,QdTime,OrderRemark,OrderAdd,LxAdd,Storeroom,ShTime,CompanyNumber,CompanyName,CompanyAdd,Unit,StockPeoNum,StockPeoName,AllMoney,YfMoney,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,MyTimes,Ifopen,Spusername,Sprealname)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@Spusername", SqlDbType.NVarChar,50),
					new SqlParameter("@Sprealname", SqlDbType.NVarChar,50)};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [StockOrder_sp] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [StockOrder_sp] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
