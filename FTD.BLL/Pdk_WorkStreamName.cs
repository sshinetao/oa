...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class Pdk_WorkStreamName
	{
		public Pdk_WorkStreamName()
		{}
		#region Model
		private long _id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [Pdk_WorkStreamName]");
			strSql.Append(" where id=@id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [Pdk_WorkStreamName] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [Pdk_WorkStreamName] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [Pdk_WorkStreamName] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
