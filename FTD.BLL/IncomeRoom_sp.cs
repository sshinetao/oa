...
namespace FTD.BLL
{
	...
	/// </summary>
	[Serializable]
	public partial class IncomeRoom_sp
	{
		public IncomeRoom_sp()
		{}
		#region Model
		private long _id;
		...
		/// 得到一个对象实体
		/// </summary>
		public IncomeRoom_sp(long Id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,number,title,ShTime,StockPeoNum,StockPeoName,Storeroom,InSource,Remark,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,Spusername,Sprealname,MyTimes ");
			strSql.Append(" FROM [IncomeRoom_sp] ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from [IncomeRoom_sp]");
			strSql.Append(" where Id=@Id ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [IncomeRoom_sp] (");
			strSql.Append("number,title,ShTime,StockPeoNum,StockPeoName,Storeroom,InSource,Remark,State,Username,Realname,Nowtimes,StreamNumber,StreamName,SpCz,Sreakmart,Spusername,Sprealname,MyTimes)");
			...
			parameters[14].Value = SpCz;
			parameters[15].Value = Sreakmart;
			parameters[16].Value = Spusername;
			parameters[17].Value = Sprealname;
			parameters[18].Value = MyTimes;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [IncomeRoom_sp] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [IncomeRoom_sp] ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt)};
			parameters[0].Value = Id;
